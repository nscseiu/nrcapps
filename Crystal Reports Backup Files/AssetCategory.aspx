<%@ Page Title="Asset Category Form & List" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="AssetCategory.aspx.cs" Inherits="NRCAPPS.ASSET.AssetCategory" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Asset Category Form & List
        <small>Asset Category: - Add - Update - Delete - View</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="../Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">IT Asset</a></li>
        <li class="active">Categorey</li>
      </ol>
    </section>
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Asset Category Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start --> 
              <div class="box-body">
                <div class="form-group">  
                 ...
                 <div class="col-sm-3">  
                    ...
                    <asp:TextBox ID="TextItemCategoreyName" class="form-control"  runat="server" AutoPostBack="True" ontextchanged="TextItemCategoreyName_TextChanged"></asp:TextBox>  
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">  
                    <asp:TextBox ID="TextItemCategoreyDes" class="form-control"  runat="server"></asp:TextBox>   
                ...
                <div class="form-group">
                  <label  class="col-sm-2 control-label">QR Code Prefix Code</label> 
                  <div class="col-sm-3">  
                    <asp:TextBox ID="TextItemCatQrPriCode" class="form-control"  runat="server"></asp:TextBox>   
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                          ControlToValidate="TextItemCatQrPriCode" ErrorMessage="Insert QR Code Prefix Code" 
                          Display="Dynamic"></asp:RequiredFieldValidator>
                  </div> 
                </div> 
                <div class="form-group">
    ...
    OnPageIndexChanging="GridViewUser_PageIndexChanging" AutoGenerateColumns="false"   CssClass="table table-bordered table-striped" >
                     ...
                     <asp:BoundField DataField="ITEM_CATEGORY_DES"  HeaderText="Category Details" /> 
                     <asp:BoundField DataField="ITEM_CAT_QR_PRI_CODE"  HeaderText="QR Code Prefix ID" /> 
                     ...
                     <asp:TemplateField>
                       <ItemTemplate>
                        <asp:LinkButton ID="linkSelectClick" class="btn btn-default btn-xs" runat="server" CommandArgument='<%# Eval("ITEM_CATEGORY_ID") %>' OnClick="linkSelectClick" CausesValidation="False">Select</asp:LinkButton> 
                        </ItemTemplate>
                       </asp:TemplateField> 
                     </Columns>
