<%@ Page Title="Asset Items & Employee Form & List" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="AssetItemsEmp.aspx.cs" Inherits="NRCAPPS.ASSET.AssetItemsEmp" %>
  ...
  <div class="content-wrapper">
               ...
               <div class="form-group">
                ...
                <div class="form-group">  
                 ...
                 <div class="col-sm-6">  
                    ...
                    <asp:ListBox runat="server" ID="DropDownItemID" class="form-control select2" data-placeholder="Select Item" AutoPostBack="True" ontextchanged="DisplayItemCatQRPriCode"  > 
                  </asp:ListBox>  
    ...
    <div class="col-md-5"> 
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Asset Item Change</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start --> 
              <div class="box-body">
               <div class="form-group">
                  ...
                  <div class="col-sm-5"> 
                  <asp:ListBox runat="server" ID="DropDownEmployeeIDChange" class="form-control select2" data-placeholder="Select Employee" AutoPostBack="True"  ontextchanged="DisplayEmpChangeItem" > 
                  </asp:ListBox>  
                ...
                <div class="form-group">  
                 ...
                 <div class="col-sm-7">  
                    ...
                    <asp:ListBox runat="server" ID="DropDownItemIDChange" class="form-control select2" data-placeholder="Select Item" > 
                  </asp:ListBox>  
        ...
        <div class="box box-success">
            ...
            <div class="box-body">  
                    <asp:GridView ID="GridViewItem" runat="server" EnablePersistedSelection="true"  AutoGenerateColumns="false"   CssClass="table table-bordered table-striped" >
                     ...
                     <asp:TemplateField>
                       <ItemTemplate>
                        <asp:LinkButton ID="linkSelectClick" class="btn btn-default btn-xs" runat="server" CommandArgument='<%# Eval("EMP_ITEMS_ID") %>' OnClick="linkSelectClick" CausesValidation="False">Select</asp:LinkButton> 
                        </ItemTemplate>
                       </asp:TemplateField> 
                     </Columns>
        ...
        <!--/.col (right) -->
          <div class="box box-danger">
           <!-- /.box-header -->
            <div class="box-header with-border">
              <h3 class="box-title">Asset Items & Employee Report</h3> 
            </div>  
            <!-- /.box-header -->
            <!-- form start --> 
              <div class="box-body">
