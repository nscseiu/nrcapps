<%@ Page Title="Asset Items Expires Form & List" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="AssetItemsExpires.aspx.cs" Inherits="NRCAPPS.ASSET.AssetItemsExpires" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Asset Expires Item Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start --> 
              <div class="box-body">
                <div class="form-group">  
                   <label for="User_Name" class="col-sm-2 control-label">Item Expires Name</label>
                 <div class="col-sm-3">  
                    <asp:TextBox ID="TextItemExpID" style="display:none" runat="server"></asp:TextBox>
                    <asp:TextBox ID="TextItemExpName" class="form-control"  runat="server" AutoPostBack="True" ontextchanged="TextItemExpName_TextChanged"></asp:TextBox>  
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                         ControlToValidate="TextItemExpName" ErrorMessage="Insert Item Name" 
                ...
                <div class="form-group">
                  <label  class="col-sm-2 control-label">Item Expires Details</label> 
                  <div class="col-sm-3">  
                    <asp:TextBox ID="TextItemExpDes" class="form-control"  runat="server"></asp:TextBox>   
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                          ControlToValidate="TextItemExpDes" ErrorMessage="Insert Item Datails" 
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-3">   
                    <asp:DropDownList ID="DropDownCategoryID" class="form-control" runat="server"> 
                    </asp:DropDownList>  
        ...
        <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Asset Expires Item List</h3>
              <div class="box-tools">
    ...
    OnPageIndexChanging="GridViewUser_PageIndexChanging" AutoGenerateColumns="false"   CssClass="table table-bordered table-striped" >
                     <Columns>
                     <asp:BoundField DataField="ITEM_EXP_ID" HeaderText="Item Expires ID" />  
                     <asp:BoundField DataField="ITEM_EXP_NAME"  HeaderText="Item Expires Name" />   
                     <asp:BoundField DataField="ITEM_EXP_DES"  HeaderText="Item Expires Details" />  
                     ...
                     <asp:TemplateField>
                       <ItemTemplate>
                        <asp:LinkButton ID="linkSelectClick" class="btn btn-default btn-xs" runat="server" CommandArgument='<%# Eval("ITEM_EXP_ID") %>' OnClick="linkSelectClick" CausesValidation="False">Select</asp:LinkButton> 
                        </ItemTemplate>
                       </asp:TemplateField> 
                     </Columns>
