<%@ Page Title=" Item Expires & Employee Form & List" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="AssetItemsExpiresEmp.aspx.cs" Inherits="NRCAPPS.ASSET.AssetItemsExpiresEmp" %>
            ...
            <!-- form start --> 
              <div class="box-body">
               <div class="form-group">
                  ...
                  <asp:ListBox runat="server" ID="DropDownEmployeeID" class="form-control select2" data-placeholder="Select Employee" AutoPostBack="True"  ontextchanged="DisplayEmpItem" > 
                  </asp:ListBox>  
                ...
                <div class="form-group">  
                 ...
                 <div class="col-sm-3">  
                    ...
                    <asp:ListBox runat="server" ID="DropDownItemID" class="form-control select2" data-placeholder="Select Item"  > 
                  </asp:ListBox>  
             ...
             <div class="form-group">  
                 ...
                 <div class="col-sm-3">   
                    <asp:ListBox runat="server" ID="DropDownItemExpID" class="form-control select2" data-placeholder="Select Item" AutoPostBack="True" ontextchanged="DisplayItemCatQRPriCode"  > 
                  </asp:ListBox>  
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-1">  
                    <asp:TextBox ID="TextQRPreCode" class="form-control"  runat="server"></asp:TextBox>   
                    <asp:TextBox ID="TextQRCode" class="form-control"  runat="server" AutoPostBack="True" ontextchanged="TextQRCode_TextChanged"></asp:TextBox>   
                    ...
                    <div class="col-sm-3"><asp:Label ID="CheckQRCode" runat="server"></asp:Label> 
                    </div> 
               </div>
               <div class="form-group">
                  <label  class="col-sm-2 control-label">Serial No.</label> 
                  <div class="col-sm-1">  
                    <asp:TextBox ID="TextSerialNo" class="form-control"  runat="server"></asp:TextBox>     
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-2">  
                    <asp:TextBox ID="TextActivationCode" class="form-control"  runat="server"></asp:TextBox>     
              ...
              <div class="col-sm-3">  
                <div class="input-group">
                  ...
                  <asp:TextBox ID="TextStartExpiryDate" class="form-control pull-right"  runat="server"></asp:TextBox> 
                </div>
                  </div>
               </div>
                <!-- /.input group -->
                <div class="form-group">
                  ...
                  <div class="col-sm-1">  
                    <asp:TextBox ID="TextExpiredDays" class="form-control"  runat="server"></asp:TextBox>     
        ...
        <div class="box box-success">
            ...
            <div class="box-body">  
                    <asp:GridView ID="GridViewItem" runat="server" EnablePersistedSelection="true"  AutoGenerateColumns="false"   CssClass="table table-bordered table-striped" >
                     ...
                     <asp:TemplateField>
                       <ItemTemplate>
                        <asp:LinkButton ID="linkSelectClick" class="btn btn-default btn-xs" runat="server" CommandArgument='<%# Eval("EMP_ITEM_EXP_ID") %>' OnClick="linkSelectClick" CausesValidation="False">Select</asp:LinkButton> 
                        </ItemTemplate>
                       </asp:TemplateField> 
                     </Columns>
