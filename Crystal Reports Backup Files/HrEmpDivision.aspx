...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
              ...
              <div class="box-body">
                <div class="form-group">  
                 ...
                 <div class="col-sm-3">  
                    ...
                    <asp:TextBox ID="TextDivisionName" class="form-control"  runat="server" AutoPostBack="True" ontextchanged="TextDivisionName_TextChanged"></asp:TextBox>  
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">  
                    <asp:TextBox ID="TextDivisionAdd" class="form-control"  runat="server"></asp:TextBox>   
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">  
                   <div class="input-group my-colorpicker2">
                    <asp:TextBox ID="TextDivBgColor" class="form-control"  runat="server"></asp:TextBox> 
    ...
    OnPageIndexChanging="GridViewUser_PageIndexChanging" AutoGenerateColumns="false"   CssClass="table table-bordered table-striped" >
                     ...
                     <asp:TemplateField>
                       <ItemTemplate>
                        <asp:LinkButton ID="linkSelectClick" class="btn btn-default btn-xs" runat="server" CommandArgument='<%# Eval("DIVISION_ID") %>' OnClick="linkSelectClick" CausesValidation="False">Select</asp:LinkButton> 
                        </ItemTemplate>
                       </asp:TemplateField> 
                     </Columns>
