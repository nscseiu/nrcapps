<%@ Page Title="Dashboard Items Form & List" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="NrcDashboardItem.aspx.cs" Inherits="NRCAPPS.NRC.NrcDashboardItem" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Dashboard Items Form & List
        <small>Dashboard Items: - Add - Update - Delete</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="../Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Dashboard Settings</a></li>
        <li class="active">Dashboard Items</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Dashboard Items Form</h3>
            </div>
            <!-- /.box-header --> 
            <!-- form start --> 
              <div class="box-body">
                <div class="form-group">
                  <label  class="col-sm-2 control-label">Dashboard Item Name</label> 
                  <div class="col-sm-3">  
                    <asp:TextBox ID="TextDashboardItemID" style="display:none" runat="server"></asp:TextBox>
                      <asp:TextBox ID="TextDashboardItemName" class="form-control"  runat="server" AutoPostBack="True" 
                        ontextchanged="TextDashboardItemName_TextChanged"></asp:TextBox>   
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextDashboardItemName" ErrorMessage="insert dashboard item" Display="Dynamic" SetFocusOnError="True"></asp:RequiredFieldValidator>
                  </div>
                   <div class="col-sm-3"><asp:Label ID="CheckDashboardItemName" runat="server"></asp:Label></div> 
                </div>
        ...
        <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Dashboard Items List</h3>
              <div class="box-tools">
    ...
    OnPageIndexChanging="GridViewEmp_PageIndexChanging" AutoGenerateColumns="false" CssClass="table table-bordered table-striped" >
                     <Columns>
                     <asp:BoundField DataField="DASH_ITEM_ID" HeaderText="Dashboard Items ID" />
                     ...
                     <asp:TemplateField>
                       <ItemTemplate>
                        <asp:LinkButton ID="linkSelectClick" class="btn btn-default btn-xs" runat="server" CommandArgument='<%# Eval("DASH_ITEM_ID") %>' OnClick="linkSelectClick" CausesValidation="False">Select</asp:LinkButton> 
                        </ItemTemplate>
                       </asp:TemplateField> 
                     </Columns>
