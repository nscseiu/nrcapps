<%@ Page Title="User Page Permission Form & List" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="NrcUserPagePermissionsOld.aspx.cs" Inherits="NRCAPPS.NRC.NrcUserPagePermissionsOld" %>
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
</asp:Content>
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
    
     <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper" style="min-height: 715px!important;">
...
.hidden {display:none;}
              ...
              <asp:GridView ID="GridView3" runat="server"   AutoGenerateColumns="false"   CssClass="table table-bordered table-striped" >
                     ...
                     <asp:TemplateField HeaderText="IS Page" HeaderStyle-HorizontalAlign="center"  ItemStyle-HorizontalAlign="center"> 
                        <ItemTemplate>  
                              <asp:CheckBox type="checkbox" id="IsPageActive" AutoPostBack="true"  OnCheckedChanged="chkStatus_IsPgaeActiveChanged"  checked='<%# Eval("IS_PAGE_ACTIVE").ToString() == "Enable" ? true : false %>'    runat="server"/>
                         </ItemTemplate>
                     </asp:TemplateField>
                     <asp:TemplateField HeaderText="IS Add" HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="center">
                        <ItemTemplate> 
                             <asp:CheckBox type="checkbox"  id="IsAddActive"   checked='<%# Eval("IS_ADD_ACTIVE").ToString() == "Enable" ? true : false %>'   runat="server"/>
                          </ItemTemplate>
                     </asp:TemplateField>
                     <asp:TemplateField HeaderText="IS Edit" HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="center">
                        <ItemTemplate> 
                            <asp:CheckBox type="checkbox"   id="IsEditActive"    checked='<%# Eval("IS_EDIT_ACTIVE").ToString() == "Enable" ? true : false %>'   runat="server"/>
                          </ItemTemplate>
                     </asp:TemplateField>
                     <asp:TemplateField HeaderText="IS Del" ItemStyle-HorizontalAlign="center" >
                        <ItemTemplate> 
                            <asp:CheckBox type="checkbox"   id="IsDelActive"    checked='<%# Eval("IS_DELETE_ACTIVE").ToString() == "Enable" ? true : false %>'   runat="server"/>
                         </ItemTemplate>
                     </asp:TemplateField>   
                     <asp:TemplateField HeaderText="IS View" ItemStyle-HorizontalAlign="center" >
                        <ItemTemplate>  
                            <asp:CheckBox type="checkbox"   id="IsViewActive"   checked='<%# Eval("IS_VIEW_ACTIVE").ToString() == "Enable" ? true : false %>'   runat="server"/>
                         </ItemTemplate>
                       </asp:TemplateField>   
                    <asp:TemplateField HeaderText="IS Report" ItemStyle-HorizontalAlign="center" >
                         <ItemTemplate>  
                            <asp:CheckBox type="checkbox"   id="IsReportActive"   checked='<%# Eval("IS_REPORT_ACTIVE").ToString() == "Enable" ? true : false %>'   runat="server"/>
                         </ItemTemplate>
                     </asp:TemplateField>   
