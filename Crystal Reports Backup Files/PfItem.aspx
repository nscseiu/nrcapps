<%@ Page Title="Item Form & List - Plastic Factory" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="PfItem.aspx.cs" Inherits="NRCAPPS.PF.PfItem" %>
              ...
              <div class="box-body">
                <div class="form-group">  
                 ...
                 <div class="form-group">  
                   <label for="User_Name" class="col-sm-2 control-label">Item Name</label>
                 <div class="col-sm-3">   
                    <asp:TextBox ID="TextIteCode" class="form-control input-sm"  runat="server" AutoPostBack="True" ontextchanged="TextItemCode_TextChanged"></asp:TextBox>  
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                         ControlToValidate="TextIteCode" ErrorMessage="Insert Item Code" 
                         SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator> 
                  </div> 
