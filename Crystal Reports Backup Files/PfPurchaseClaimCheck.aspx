<%@ Page Title="Purchase Claim Check Form & List" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="PfPurchaseClaimCheck.aspx.cs" Inherits="NRCAPPS.PF.PfPurchaseClaimCheck" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Purchase Claim Check Form & List
        <small>Purchase Claim Check: - Add - Update - Delete</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="../Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Plastic Factory</a></li>
        <li class="active">Purchase Claim Check</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Purchase Claim Check Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  <label  class="col-sm-2 control-label">Query For This Claim</label> 
                  <div class="col-sm-3" style="padding-top:6px;">    
                        <label>
                  ...
                  <div class="form-group">
                  <label  class="col-sm-2 control-label">CMO Check Status</label> 
                  <div class="col-sm-3" style="padding-top:6px;">    
                        <label>
        ...
        <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Purchase Claim Check List</h3>
              <div class="box-tools">
            ...
            <div class="box-body"> 
                    <asp:GridView ID="GridView1" runat="server"    EnablePersistedSelection="true"         
                     ...
                     <asp:BoundField DataField="OBJ_QUERY_DES" HeaderText="Query Description" />  
                     <asp:BoundField DataField="OBJ_QUERY_C_DATE"  HeaderText="Query Date"  DataFormatString="{0:dd/MM/yyyy h:mm:ss tt}"  />
                      <asp:TemplateField  HeaderText="Action" >
                       ...
                       <asp:TemplateField HeaderText="CMO Check" ItemStyle-Width="100">
                        <ItemTemplate> 
