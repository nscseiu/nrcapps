  ...
  <div class="content-wrapper">
    ...
    OnPageIndexChanging="GridViewEmp_PageIndexChanging" AutoGenerateColumns="false" CssClass="table table-bordered table-striped" >
         ...
         <!-- /.box -->
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"> Sales Statement (Customer Wise - Monthly) Parameter</h3>
            </div>
            <!-- /.box-header --> 
              <div class="box-body">
            <!-- form start --> 
                <div class="form-group">
                      <label  class="col-sm-2 control-label">Customer Name</label> 
                      <div class="col-sm-3">   
                        <asp:DropDownList ID="DropDownCustomerID1" class="form-control input-sm" runat="server"> 
                        </asp:DropDownList>  
         ...
         <!-- /.box -->
            ...
            <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title"> Sales Statement (Customer Wise - Monthly) Report View</h3>
            </div> 
            <!-- /.box-header -->
                    <div class="box-body">       
