<%@ Page Title="Sales Check Form & List" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="PfSalesCheck.aspx.cs" Inherits="NRCAPPS.PF.PfSalesCheck" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Sales Check Form & List
        <small>Sales Check: - Add - Update - Delete</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="../Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Plastic Factory</a></li>
        <li class="active">Sales Check</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Sales Check Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
        ...
        <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Sales Check List</h3>
              <div class="box-tools">
              <div class="input-group input-group-sm" style="width: 200px;">
                <asp:TextBox ID="txtSearchEmp" Class="form-control input-sm" runat="server" />
                 ...
                 <asp:LinkButton ID="LinkButton6" class="btn btn-success" runat="server" 
                          Text="Update"  onclick="BtnUpdateSalesCheck_Click" ValidationGroup='valGroup1' ClientIDMode="Static"></asp:LinkButton> 
                  </div>  
              </div>    
            </div>
            </div>
