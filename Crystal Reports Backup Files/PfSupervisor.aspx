...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Supervisor Form & List
        <small>Supervisor: - Add - Update - Delete - View</small>
      </h1>
      <ol class="breadcrumb">
            ...
            <!-- form start --> 
              <div class="box-body">
                <div class="form-group">  
                   <label for="User_Name" class="col-sm-2 control-label">Supervisor Name</label>
                 <div class="col-sm-3">  
                    ...
                    <asp:TextBox ID="TextSupervisorName" class="form-control input-sm"  runat="server" AutoPostBack="True" ontextchanged="TextSupervisorName_TextChanged"></asp:TextBox>  
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                         ControlToValidate="TextSupervisorName" ErrorMessage="Insert Supervisor Name" 
    ...
    OnPageIndexChanging="GridViewUser_PageIndexChanging" AutoGenerateColumns="false"   CssClass="table table-bordered table-striped" >
                     <Columns>
                     <asp:BoundField DataField="SUPERVISOR_ID" HeaderText="Supervisor ID" />  
