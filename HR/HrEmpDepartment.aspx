<%@ Page Title="Department Form & List" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="HrEmpDepartment.aspx.cs" Inherits="NRCAPPS.HR.HrEmpDepartment" %>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Department: - Add - Update - Delete - View</small>
      </h1>
      <ol class="breadcrumb">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                <div class="form-group">  
                   <label for="User_Name" class="col-sm-2 control-label">Department Name</label>
                 <div class="col-sm-3">  
                    <asp:TextBox ID="TextDepartmentID" style="display:none" runat="server"></asp:TextBox>
                    <asp:TextBox ID="TextDepartmentName" class="form-control input-sm"  runat="server" AutoPostBack="True" ontextchanged="TextDepartmentName_TextChanged"></asp:TextBox>  
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                         ControlToValidate="TextDepartmentName" ErrorMessage="Insert Department Name" 
                         SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator> 
                  </div> 
                    <div class="col-sm-3"><asp:Label ID="CheckUserDepartmentName" runat="server"></asp:Label> 
                    </div>
                </div>
                <div class="form-group">
                  <label  class="col-sm-2 control-label">Department Address</label> 
                  <div class="col-sm-3">  
                    <asp:TextBox ID="TextDepartmentAdd" class="form-control input-sm"  runat="server"></asp:TextBox>   
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                          ControlToValidate="TextDepartmentAdd" ErrorMessage="Insert Department Address" 
    ...
    OnPageIndexChanging="GridViewUser_PageIndexChanging" AutoGenerateColumns="false"   CssClass="table table-bordered table-striped" >
                     ...
                     <asp:BoundField DataField="DEPARTMENT_ADD"  HeaderText="Department Address" /> 
                     ...
                     <asp:TemplateField>
                       <ItemTemplate>
                        <asp:LinkButton ID="linkSelectClick" class="btn btn-info btn-xs" runat="server" CommandArgument='<%# Eval("DEPARTMENT_ID") %>' OnClick="linkSelectClick" CausesValidation="False">Select</asp:LinkButton> 
                        </ItemTemplate>
                       </asp:TemplateField> 
                     </Columns>
