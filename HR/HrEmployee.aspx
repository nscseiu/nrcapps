...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
            ...
            <!-- form start -->
              ...
              <div class="form-group">  
                ...
                <div class="form-group">  
                  ...
                  <div class="col-sm-2">   
                    <asp:DropDownList ID="DropDownGender" class="form-control input-sm" runat="server" disabled="disabled">  
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-3">  
                  <asp:TextBox ID="TextNid" class="form-control input-sm" runat="server"></asp:TextBox>
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-3">   
                    <asp:DropDownList ID="DropDownDepartmentID" class="form-control input-sm" runat="server"> 
                    </asp:DropDownList>  
    ...
    SelectedRowStyle-BackColor="Yellow"   AutoGenerateColumns="false" CssClass="table table-bordered table-striped" >
                     ...
                     <asp:TemplateField>
                       <ItemTemplate>
                        <asp:LinkButton ID="linkSelectClick" class="btn btn-info btn-xs" runat="server" CommandArgument='<%# Eval("EMP_ID") %>' OnClick="linkSelectClick" CausesValidation="False">Select</asp:LinkButton> 
                        </ItemTemplate>
                       </asp:TemplateField> 
                     </Columns>
