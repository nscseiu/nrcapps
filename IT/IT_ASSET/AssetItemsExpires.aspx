<%@ Page Title="Asset Items Expires Form & List" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="AssetItemsExpires.aspx.cs" Inherits="NRCAPPS.IT.IT_ASSET.AssetItemsExpires" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
              ...
              <div class="box-body">
                <div class="form-group">  
                 ...
                 <div class="col-sm-3">  
                    ...
                    <asp:TextBox ID="TextItemExpName" class="form-control input-sm"  runat="server" AutoPostBack="True" ontextchanged="TextItemExpName_TextChanged"></asp:TextBox>  
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">  
                    <asp:TextBox ID="TextItemExpDes" class="form-control input-sm"  runat="server"></asp:TextBox>   
    ...
    OnPageIndexChanging="GridViewUser_PageIndexChanging" AutoGenerateColumns="false"   CssClass="table table-bordered table-striped" >
                     ...
                     <asp:TemplateField>
                       <ItemTemplate>
                        <asp:LinkButton ID="linkSelectClick" class="btn btn-info btn-xs" runat="server" CommandArgument='<%# Eval("ITEM_EXP_ID") %>' OnClick="linkSelectClick" CausesValidation="False">Select</asp:LinkButton> 
                        </ItemTemplate>
                       </asp:TemplateField> 
                     </Columns>
