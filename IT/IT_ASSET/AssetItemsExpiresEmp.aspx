...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
    ...
    <section class="content">
      <div class="row">
            ...
            <!-- form start --> 
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-3">  
                   <asp:TextBox ID="TextItemExpID" style="display:none" runat="server"></asp:TextBox>
               ...
               <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-3"> 
                  <asp:DropDownList runat="server" ID="DropDownLocationID" class="form-control input-sm" data-placeholder="Select Location"   > 
                  </asp:DropDownList>  
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" 
                          ControlToValidate="DropDownLocationID" Display="Dynamic" 
                          ErrorMessage="Select Location" InitialValue="0" SetFocusOnError="True" ></asp:RequiredFieldValidator>
                  </div>
                </div>
                <div class="form-group">
                  <label  class="col-sm-2 control-label">Select Placement</label> 
                  <div class="col-sm-3 "> 
                  <asp:DropDownList runat="server" ID="DropDownPlacementID" class="form-control input-sm" data-placeholder="Select Location" AutoPostBack="True"  ontextchanged="DisplayEmpItem" > 
                  </asp:DropDownList>   
                  </div>
                </div>
                 </div>
             ...
             <div class="form-group">  
                 ...
                 <div class="col-sm-3">   
                    <asp:ListBox runat="server" ID="DropDownItemExpID" class="form-control  input-sm select2" data-placeholder="Select Item"  > 
                  </asp:ListBox>  
        ...
        <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Item Expires & Employee/Department List</h3>
            ...
            <div class="box-body table-responsive">  
                    ...
                    <asp:GridView ID="GridViewItem" runat="server" EnablePersistedSelection="true"  AutoGenerateColumns="false"   CssClass="table table-bordered table-striped" >
                     ...
                     <asp:TemplateField HeaderText="Remaining Days">
                        <ItemTemplate>
                            ...
                            <div id="progress_bar" class="progress-bar progress-bar-primary progress-bar-striped" role="progressbar" aria-valuenow='<%# Eval("EXPIRED_DAYS_BET")%>' aria-valuemin="0" aria-valuemax='<%# Eval("EXPIRED_DAYS")%>' style='<%#"width:" + ((Decimal.Parse(Eval("EXPIRED_DAYS_BET").ToString())/(Decimal.Parse(Eval("EXPIRED_DAYS").ToString())))*100)+"%"%>'  runat="server">
                               <%# Eval("EXPIRED_DAYS_BET")%> days Of <%# Eval("EXPIRED_DAYS")%> days
                            </div>
                          </div>             
                        </ItemTemplate>
                      </asp:TemplateField>   
                    ...
                    <asp:GridView ID="GridViewItemDept" runat="server" EnablePersistedSelection="true"  AutoGenerateColumns="false"   CssClass="table table-bordered table-striped" >
                     <Columns>
                     <asp:BoundField DataField="EMP_ITEM_EXP_ID" HeaderText="Item Exp. ID" /> 
                     <asp:BoundField DataField="ITEM_EXP_NAME"  HeaderText="Item Exp. Name" /> 
                     <asp:BoundField DataField="SERIAL_NO"  HeaderText="Serial No." /> 
                     <asp:BoundField DataField="ACTIVATION_CODE"  HeaderText="Activation Code" />
                     <asp:BoundField DataField="PLACEMENT_NAME"  HeaderText="Placement Name" />
                     <asp:TemplateField HeaderText="Remaining Days">
                        <ItemTemplate>
                             <div class="progress active">
                            <div id="progress_bar" class="progress-bar progress-bar-primary progress-bar-striped" role="progressbar" aria-valuenow='<%# Eval("EXPIRED_DAYS_BET")%>' aria-valuemin="0" aria-valuemax='<%# Eval("EXPIRED_DAYS")%>' style='<%#"width:" + ((Decimal.Parse(Eval("EXPIRED_DAYS_BET").ToString())/(Decimal.Parse(Eval("EXPIRED_DAYS").ToString())))*100)+"%"%>'  runat="server">
 ...
 <style>
     ...
     #ctl00_ContentPlaceHolder1_GridViewItem {background-color: #fff; margin: 5px 0 10px 0; border: solid 1px #525252; border-collapse:collapse; font-family:Calibri; color: #474747;}

  #ctl00_ContentPlaceHolder1_GridViewItem td {

      padding: 2px;

      border: solid 1px #c1c1c1; }

  #ctl00_ContentPlaceHolder1_GridViewItem th  {
  ...
  #ctl00_ContentPlaceHolder1_GridViewItem .alt {

      background: #fcfcfc url(Images/grid-alt.png) repeat-x top; }

  #ctl00_ContentPlaceHolder1_GridViewItem .pgr {background: #363670 url(Images/grid-pgr.png) repeat-x top; }

  #ctl00_ContentPlaceHolder1_GridViewItem .pgr table { margin: 3px 0; }

  #ctl00_ContentPlaceHolder1_GridViewItem .pgr td { border-width: 0; padding: 0 6px; border-left: solid 1px #666; font-weight: bold; color: #fff; line-height: 12px; }  

  #ctl00_ContentPlaceHolder1_GridViewItem .pgr a { color: Gray; text-decoration: none; }

  #ctl00_ContentPlaceHolder1_GridViewItem .pgr a:hover { color: #000; text-decoration: none; }
 </style>
</div>
