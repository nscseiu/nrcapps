<%@ Page Title="Batch & Item Form & List - Metal Factory" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="MfBatchItem.aspx.cs" Inherits="NRCAPPS.MF.MfBatchItem" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
        ...
        <div class="col-md-8"> 
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Batch & Item Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start --> 
              <div class="box-body"> 
                  ...
                  <div class="col-sm-4">   
                    <asp:DropDownList ID="DropDownGradeID" class="form-control select2 input-sm" runat="server"  AutoPostBack="True" ontextchanged="GetGradeTempleteDetails"> 
                     ...
                     <div class="col-sm-1">    
                      ...
                      <div class="col-sm-1">
                        <asp:LinkButton ID="BtnGradeCopyBatch" class="btn btn-success btn-sm" runat="server" Text="Add" onclick="InsertGradeCopyBatch"  CommandName="InsertGradeCopyBatch" ValidationGroup="GroupBatch" OnClientClick="return confirm('Are you confirm Grade (Templete) Copy For This Batch?')" >
                          <span aria-hidden="true" class="fa fa-refresh"></span> Grade (Template) Copy & Create Batch
                        </asp:LinkButton>
                      </div>
                </div>
                    <div class="form-group">
            ...
            <Columns>
                ...
                <asp:TemplateField>
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="TextItemWeight" runat="server" class="form-control input-sm" Text='<%#Bind("ITEM_WEIGHT_CWT") %>' />
 ...
 <div class="col-md-4">  
        ...
        <div class="col-md-12">    
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Batch & Item List</h3>
              <div class="box-tools">
                     ...
                     <Columns> 
                      <asp:TemplateField HeaderText="Batch No">
                       ...
                       <ItemTemplate>
                        ...
                        <asp:LinkButton ID="BtBatchPost_Click" class="btn bg-purple btn-sm" runat="server" CommandArgument='<%# Eval("BATCH_ID") %>' OnClientClick="return confirm('Are you confirm post this batch?')" OnClick="BtBatchPost_Click" CausesValidation="False"><i class="fa fa-fw fa-envelope-o"></i> Batch Post</asp:LinkButton> 
                        <asp:Label ID="IsBatchPost" style="display:none" CssClass="label" Text='<%# Eval("CREATE_POST_S").ToString() == "Complete" ? "Complete" : "Incomplete" %>'  runat="server" /> 
                         </ItemTemplate>
                       </asp:TemplateField> 
