<%@ Page Title="Material Pricing (Overseas) Form & List" Language="C#" MasterPageFile="~/Site.Master" EnableEventValidation="false" AutoEventWireup="true"  CodeBehind="MfExpMaterialPricing.aspx.cs" Inherits="NRCAPPS.MF.MfExpMaterialPricing" %>
  ...
  <div class="content-wrapper">
    <script language="javascript" type="text/javascript">
               ...
               function GetItemDataListWp() {   
                         var Item_Wt = $("#ctl00_ContentPlaceHolder1_DropDownSlipNoEx").val().split('-');
                   
                            $.ajax({
                                        type: "POST",
                                        url: "MfExpMaterialPricing.aspx/GetSalesItemList",
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-info">
            ...
            <!-- form start --> 
                  ...
                  <div class="col-sm-9">    
                  <asp:DropDownList runat="server" ID="DropDownSlipNoEx" class="form-control select2" onchange="GetItemDataListWp()"  > 
                  </asp:DropDownList>  
                 ...
                 <div class="form-group">
                  <label  class="col-sm-2 control-label">Select Sales Item Name</label> 
                  <div class="col-sm-3">    
                  <asp:DropDownList runat="server" ID="DropDownSalesItemID" class="form-control" > 
                      ...
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                          ...
                          ErrorMessage="Select Sales Item" InitialValue="0" SetFocusOnError="True"></asp:RequiredFieldValidator>
                  </div>
                </div>    
                <div class="form-group">   
               ...
               <div class="form-group">   
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                  <label  class="col-sm-2 control-label">Is Not WB Slip/Container Edit</label> 
            ...
            <div class="box-body table-responsive"> 
                    <asp:GridView ID="GridView1" runat="server"    EnablePersistedSelection="true"    OnDataBound="gridViewFileInformation_DataBound"        
                     ...
                     <asp:TemplateField HeaderText="Is Not WB Slip/Container Edit Status" ItemStyle-Width="100">
                        <ItemTemplate> 
                             <asp:Label ID="IsActiveGV"   Text='<%# Eval("IS_ACTIVE_PRICING").ToString() == "Enable" ? "<span Class=\"label label-success\" style=Padding:2px >Enable<span>" : "<span Class=\"label label-danger\">Disable<span>" %>'  runat="server" /> 
