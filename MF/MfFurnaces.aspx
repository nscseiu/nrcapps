<%@ Page Title="Furnaces Form & List - Metal Factory" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="MfFurnaces.aspx.cs" Inherits="NRCAPPS.MF.MfFurnaces" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Furnaces Form & List
        <small>Furnaces: - Add - Update - Delete - View</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="../Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Metal Factory</a></li>
        <li class="active">Furnaces</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Furnaces Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start --> 
              <div class="box-body"> 
                <div class="form-group">  
                   <label for="TextFurnacesName" class="col-sm-2 control-label">Furnaces Name</label>
                 <div class="col-sm-3">  
                    <asp:TextBox ID="TextFurnacesID" style="display:none" runat="server"></asp:TextBox>
                    <asp:TextBox ID="TextFurnacesName" class="form-control input-sm"  runat="server" AutoPostBack="True" ontextchanged="TextFurnacesName_TextChanged"></asp:TextBox>  
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                         ControlToValidate="TextFurnacesName" ErrorMessage="Insert Furnaces Name" 
                         SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator> 
                  </div> 
                    <div class="col-sm-3"><asp:Label ID="CheckFurnacesName" runat="server"></asp:Label> 
                    </div>
                </div>
                 <div class="form-group">  
                 ...
                 <div class="col-sm-3">   
                    ...
                    <asp:TextBox ID="TextDescription" class="form-control input-sm"  runat="server" ></asp:TextBox> <!--  AutoPostBack="True"  ontextchanged="TextFurnacesRate_Changed" -->   
                    <span class="input-group-addon">Direction</span>      
                    </div>  
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                         ControlToValidate="TextDescription" ErrorMessage="Insert Furnaces Code" 
                         SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator> 
                  </div> 
                    <div class="col-sm-3"><asp:Label ID="CheckFurnacesCode" runat="server"></asp:Label> 
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Furnaces List</h3>
              <div class="box-tools">
    ...
    OnPageIndexChanging="GridViewUser_PageIndexChanging" AutoGenerateColumns="false"   CssClass="table table-bordered table-striped" >
                     <Columns> 
                     <asp:BoundField DataField="FURNACES_ID" HeaderText="Furnaces ID" />  
                     <asp:BoundField DataField="FURNACES_NAME"  HeaderText="Furnaces Name" />  
                     <asp:BoundField DataField="FURNACES_DESCRIPTION"  HeaderText="Description" />     
                     ...
                     <asp:TemplateField>
                       <ItemTemplate>
                        <asp:LinkButton ID="linkSelectClick" class="btn btn-info btn-xs" runat="server" CommandArgument='<%# Eval("FURNACES_ID") %>' OnClick="linkSelectClick" CausesValidation="False">Select</asp:LinkButton> 
                        </ItemTemplate>
                       </asp:TemplateField> 
                     </Columns>
