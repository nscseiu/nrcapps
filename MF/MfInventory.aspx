<%@ Page Title="Inventory Raw Material Form & List - Metal Factory" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="MfInventory.aspx.cs" Inherits="NRCAPPS.MF.MfInventory" %>
           ...
           <div class='box'> 
            <div class='box-header with-border'> 
              <h3 class='box-title'><i class='fa fa-building-o'></i> 
                 Inventory Raw Material Statement-(Default Current Month) 
                ...
                <div class='box-tools'>
                   ...
                   <div class="input-group date" style="width: 300px;">
                      ...
                      <asp:Button ID="Button2" Class="btn btn-info"   
                        Text="Search" runat="server" OnClick="DisplayInventoryRmSearch" 
    ...
    OnPageIndexChanging="GridViewHistory_PageIndexChanging" AutoGenerateColumns="false"   CssClass="table table-hover table-bordered table-striped" >
         ...
         <div class='col-md-12'> 
           <div class='box'> 
            <div class='box-header with-border'> 
              <h3 class='box-title'><i class='fa fa-building-o'></i> 
                 Inventory Finished Goods Statement-(Default Current Month) 
                ...
                <div class='box-tools'>
                   ...
                   <div class="input-group date" style="width: 300px;">
                      <div class="input-group-addon">
                       ...
                       <asp:TextBox  class="form-control pull-right" ID="EntryDate1"  runat="server"   ></asp:TextBox> 
                         <div class="input-group-btn">
                      <asp:Button ID="Button3" Class="btn btn-info"   
                        Text="Search" runat="server" OnClick="DisplayInventoryFgSearch" 
                        CausesValidation="False" />
                  </div>  
                     </div> 
                     </div> 
                    ...
                    <asp:PlaceHolder ID = "PlaceHolderInventoryFgReport" runat="server" />   
