<%@ Page Title="Item Form & List - Metal Factory" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="MfItem BinBin.aspx.cs" Inherits="NRCAPPS.MF.MfItemBin" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Item Bin Form & List
        <small>Item Bin: - Add - Update - Delete - View</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="../Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Metal Factory</a></li>
        <li class="active">Item Bin</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Item Bin Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start --> 
              <div class="box-body">
              <div class="form-group">
                ...
                <div class="form-group">  
                   <label for="TextItemName" class="col-sm-2 control-label">Item Bin Name</label>
                 <div class="col-sm-3">  
                    ...
                    <asp:TextBox ID="TextItemName" class="form-control input-sm"  runat="server" AutoPostBack="True" ontextchanged="TextItemName_TextChanged"></asp:TextBox>  
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                         ControlToValidate="TextItemName" ErrorMessage="Insert Item Bin Name" 
                 ...
                 <div class="form-group">  
                   <label for="User_Name" class="col-sm-2 control-label">Capacity (KG)</label>
                 <div class="col-sm-3">   
                       <div class="input-group"> 
                    <asp:TextBox ID="TextCapacityWeight" class="form-control input-sm"  runat="server" ></asp:TextBox> <!--  AutoPostBack="True"  ontextchanged="TextItemRate_Changed" -->   
                    <span class="input-group-addon">KG</span>      
                    </div>  
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                         ControlToValidate="TextCapacityWeight" ErrorMessage="Insert Item Code" 
                         SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator> 
                  </div> 
        ...
        <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Item Bin List</h3>
              <div class="box-tools">
    ...
    OnPageIndexChanging="GridViewUser_PageIndexChanging" AutoGenerateColumns="false"   CssClass="table table-bordered table-striped" >
                     <Columns> 
                     <asp:BoundField DataField="ITEM_BIN_ID" HeaderText="Item Bin ID" />  
                     <asp:BoundField DataField="ITEM_BIN_NAME"  HeaderText="Item Bin Name" />  
                     <asp:BoundField DataField="CAPACITY_WEIGHT"  HeaderText="Bin Capacity (KG)" /> 
                     ...
                     <asp:TemplateField>
                       <ItemTemplate>
                        <asp:LinkButton ID="linkSelectClick" class="btn btn-info btn-xs" runat="server" CommandArgument='<%# Eval("ITEM_BIN_ID") %>' OnClick="linkSelectClick" CausesValidation="False">Select</asp:LinkButton> 
                        </ItemTemplate>
                       </asp:TemplateField> 
                     </Columns>
