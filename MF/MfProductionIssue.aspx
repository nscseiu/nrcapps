<%@ Page Title="Issue For Production Form & List - Metal Factory" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="MfProductionIssue.aspx.cs" Inherits="NRCAPPS.MF.MfProductionIssue" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Issue For Production Form & List
        <small>Issue For Production: - Add - Update - Delete - View</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="../Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li> 
        <li><a href="#">Metal Factory</a></li>
        <li class="active">Issue For Production</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-8"> 
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Issue For Production Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start --> 
              <div class="box-body">  
                 ...
                 <div class="col-sm-3">    
                   <asp:DropDownList ID="DropDownBatchNo" class="form-control select2 input-sm" runat="server" AutoPostBack="True" ontextchanged="GetBatchData" > 
                     ...
                     <asp:TextBox ID="TextProductionID" class="form-control input-sm" style="display:none" runat="server" ></asp:TextBox> 
            ...
            DataKeyNames="ISSUE_ITEM_ID,PRODUCTION_ID,BATCH_NO,ITEM_ID" CellPadding="10" CellSpacing="0"
            ShowFooter="true"
            ...
            <Columns>
                ...
                <asp:TemplateField>
                 ...
                 <asp:TemplateField>
                    <HeaderTemplate>Gross WT-KG</HeaderTemplate>
                    <ItemTemplate><%#Eval("FIRST_WT","{0:N2}") %></ItemTemplate>
                    <EditItemTemplate>
                        <asp:TextBox ID="TextFirstWeight" runat="server" class="form-control input-sm" Text='<%#Bind("FIRST_WT") %>' AutoPostBack="true"  ontextchanged="Check_First_Wt" />
                        <asp:RequiredFieldValidator ID="rfCPFEdit" runat="server" ForeColor="Red" ErrorMessage="*"
                             Display="Dynamic" ValidationGroup="edit" ControlToValidate="TextFirstWeight">Insert Gross Weight</asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="RequiredFieldValidator26" runat="server" ControlToValidate="TextFirstWeight" ErrorMessage="WT must be greater than 0."  Display="Dynamic" ValidationExpression="^[1-9][0-9]*$" SetFocusOnError="true" ValidationGroup="Add" >
                             </asp:RegularExpressionValidator>
                    </EditItemTemplate>
                    <FooterTemplate>
                        <asp:TextBox ID="TextFirstWeight" class="form-control input-sm" value="0"  runat="server" AutoPostBack="true"  ontextchanged="Check_First_Wt" ></asp:TextBox> 
                        <asp:RequiredFieldValidator ID="rfCPF"   runat="server" ErrorMessage="*"
                            ForeColor="Red" Display="Dynamic" ValidationGroup="Add" ControlToValidate="TextFirstWeight">Insert Gross Weight</asp:RequiredFieldValidator>
                             <asp:RegularExpressionValidator ID="RequiredFieldValidator25" runat="server" ControlToValidate="TextFirstWeight" ErrorMessage="WT must be greater than 0."  Display="Dynamic" ValidationExpression="^[1-9][0-9]*$" SetFocusOnError="true" ValidationGroup="Add" >
                             </asp:RegularExpressionValidator>
                    </FooterTemplate>
                </asp:TemplateField>

                <asp:TemplateField>
                    <HeaderTemplate>Tare WT-KG</HeaderTemplate>
                    <ItemTemplate><%#Eval("SECOND_WT","{0:N2}") %></ItemTemplate>
                    <EditItemTemplate>
                        <asp:TextBox ID="TextSecondWeight" runat="server" class="form-control input-sm" Text='<%#Bind("SECOND_WT") %>' AutoPostBack="true"  ontextchanged="Check_Second_Wt" />
                        <asp:RequiredFieldValidator ID="rfCPSEdit" runat="server" ForeColor="Red" ErrorMessage="*"
                             Display="Dynamic" ValidationGroup="edit" ControlToValidate="TextSecondWeight">Insert Tare Weight</asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="RequiredFieldValidator28" runat="server" ControlToValidate="TextSecondWeight" ErrorMessage="WT must be greater than 0."  Display="Dynamic" ValidationExpression="^[1-9][0-9]*$" SetFocusOnError="true" ValidationGroup="Add" >
                             </asp:RegularExpressionValidator>
                    </EditItemTemplate>
                    <FooterTemplate>
                        <asp:TextBox ID="TextSecondWeight" class="form-control input-sm" value="0" runat="server" AutoPostBack="true"  ontextchanged="Check_Second_Wt"></asp:TextBox> 
                        <asp:RequiredFieldValidator ID="rfCPS" runat="server" ErrorMessage="*"
                            ForeColor="Red" Display="Dynamic" ValidationGroup="Add" ControlToValidate="TextSecondWeight">Insert Tare Weight</asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="RequiredFieldValidator27" runat="server" ControlToValidate="TextSecondWeight" ErrorMessage="WT must be greater than 0."  Display="Dynamic" ValidationExpression="^[1-9][0-9]*$" SetFocusOnError="true" ValidationGroup="Add" >
                             </asp:RegularExpressionValidator>
                    </FooterTemplate>
                </asp:TemplateField>

                <asp:TemplateField>
                    <HeaderTemplate>Net WT-KG</HeaderTemplate>
                    ...
                    <EditItemTemplate>
                        ...
                        <asp:RequiredFieldValidator ID="rfCPEdit" runat="server" ForeColor="Red" ErrorMessage="*"
                             Display="Dynamic" ValidationGroup="edit" ControlToValidate="TextItemWeight">Insert Net Weight</asp:RequiredFieldValidator>
                    </EditItemTemplate>
                    <FooterTemplate>
                        ...
                        <asp:RequiredFieldValidator ID="rfCP" runat="server" ErrorMessage="*"
                            ForeColor="Red" Display="Dynamic" ValidationGroup="Add" ControlToValidate="TextItemWeight">Insert Net Weight</asp:RequiredFieldValidator>
                    </FooterTemplate>
                      </asp:TemplateField>
                  ...
                  <asp:TemplateField>
                    ...
                    <ItemTemplate> 
                          <asp:Label ID="IsTypeName" Text='<%# Eval("TYPE_NAME") == null ? "" : Eval("TYPE_NAME").ToString() == "Batch" ? "<span class=\"label label-primary\" > Batch <span>" : "<span class=\"label label-warning\" >Correction<span>" %> '  runat="server" /> 
                     </ItemTemplate>   
                    <EditItemTemplate>
                        <asp:DropDownList ID="DropDownTypeID" class="form-control  input-sm"  runat="server" > 
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator ID="rfTEdit" runat="server" ErrorMessage="*"
                            ForeColor="Red" Display="Dynamic" ValidationGroup="edit" ControlToValidate="DropDownTypeID" InitialValue="0">
                            Select Item
                        </asp:RequiredFieldValidator>
                     </EditItemTemplate>
                    <FooterTemplate>
                        ...
                        <asp:RequiredFieldValidator ID="rfT" runat="server" ErrorMessage="*"
                            ForeColor="Red" Display="Dynamic" ValidationGroup="Add" ControlToValidate="DropDownTypeID" InitialValue="0">Select Item</asp:RequiredFieldValidator>
                    </FooterTemplate>
                </asp:TemplateField>
        ...
        <div class="col-md-12">    
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Issue For Production List</h3>
              <div class="box-tools">
    ...
    OnPageIndexChanging="GridViewUser_PageIndexChanging" AutoGenerateColumns="false"   CssClass="table table-bordered table-hover table-striped" >
                     <Columns> 
                      <asp:TemplateField HeaderText="Batch No">
                       ...
                       <ItemTemplate>
                        <asp:LinkButton ID="LinkSelectClick" class="btn btn-info btn-sm" runat="server" CommandArgument='<%# Eval("PRODUCTION_ID") %>' OnClick="LinkSelectClick" CausesValidation="False"><i class="fa fa-fw fa-folder-open"></i> Select</asp:LinkButton> 
                        <asp:LinkButton ID="BtProductionPost_Click" class="btn bg-maroon btn-sm" runat="server" CommandArgument='<%# Eval("BATCH_NO") %>' OnClientClick="return confirm('Are you confirm post this batch?')" OnClick="BtProductionPost_Click" CausesValidation="False"><i class="fa fa-fw fa-envelope-o"></i> Production Post</asp:LinkButton> 
