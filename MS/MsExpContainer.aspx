<%@ Page Title="Weight Slip & Container Form & List - Metal Scrap" Language="C#" MasterPageFile="~/Site.Master" EnableEventValidation="false"  AutoEventWireup="true"  CodeBehind="MsExpContainer.aspx.cs" Inherits="NRCAPPS.MS.MsExpContainer" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
               ...
               function GetItemDataListWp() { 
                   var ItemId = $("#ctl00_ContentPlaceHolder1_DropDownItemID").val(); 
                    ...
                    $.ajax({
                        ...
                        $.ajax({
                            type: "POST",
                            url: "MsExpContainer.aspx/GetItemWsList",
                            data: '{"ItemId": "' + ItemId + '"}',
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: function (r) {
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-8">  
            ...
            <!-- form start --> 
              <div class="box-body">  
                <div class="form-group">   
                    <label class="col-sm-2 control-label">Weight Slip No</label> 
                   <div class="col-sm-3">  
                ...
                <div class="form-group">
                  ...
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server"   ControlToValidate="DropDownPartyID" ErrorMessage="Select Customer" Display="Dynamic" SetFocusOnError="True" ></asp:RequiredFieldValidator>
                   </div>
                  ...
                  <div class="col-sm-3">   
                      ...
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server"   ControlToValidate="TextSealNo" ErrorMessage="Insert Driver Name" Display="Dynamic" SetFocusOnError="True" ></asp:RequiredFieldValidator>
                  </div> 

                </div>
                  <div class="form-group">  
                      <label  class="col-sm-2 control-label">Booking No.</label> 
                  <div class="col-sm-3">   
                      <asp:TextBox ID="TextBookingNo" class="form-control input-sm"  runat="server" ></asp:TextBox>    
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server"   ControlToValidate="TextBookingNo" ErrorMessage="Insert Driver Name" Display="Dynamic" SetFocusOnError="True" ></asp:RequiredFieldValidator>
                  </div>
                    <label  class="col-sm-4 control-label">Ref. No.</label> 
                  <div class="col-sm-3">   
                      <asp:TextBox ID="TextRefNo" class="form-control input-sm"  runat="server" ></asp:TextBox>    
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server"   ControlToValidate="TextRefNo" ErrorMessage="Insert Driver Name" Display="Dynamic" SetFocusOnError="True" ></asp:RequiredFieldValidator>
                  </div>  
                </div>
               <div class="form-group">
                  <label  class="col-sm-2 control-label"> Container No.</label> 
                  <div class="col-sm-3">   
                ...
                <div class="form-group">
                  <label  class="col-sm-2 control-label">WB Net/ Gross WT</label> 
                  <div class="col-sm-3">  
                  <div class="input-group"> 
                    ...
                    <span class="input-group-addon">KG</span>      
                     ...
                     <label  class="col-sm-4 control-label">Tare Weight</label> 
                    <div class="col-sm-3">
                        <div class="input-group"> 
         ...
         <!-- /.box -->
            ...
            <div class="box-header with-border">
              ...
              <div class="box-body"> 
                  <div class="form-group">
                  <label  class="col-sm-2 control-label"> Slip Is</label> 
                  <div class="col-sm-4"> 
                    <asp:RadioButtonList ID="radPurDuplicate" runat="server" AutoPostBack = "true"  onselectedindexchanged="Redio_MultipleChanged" RepeatDirection="Horizontal">
                         <asp:ListItem Value="One" Selected="True">One Item&nbsp;</asp:ListItem>
                         <asp:ListItem Value="Duplicate">Multiple Item</asp:ListItem> 
                    </asp:RadioButtonList>     
                  </div>
                 </div>  
                  <div class="form-group">
                  <label  class="col-sm-2 control-label">Select Weight Slip</label> 
                  <div class="col-sm-3">    
                      ...
                      <div class="col-sm-6"> 
                         <div class="input-group"> 
                            <asp:TextBox ID="TextItemWtWb" class="form-control input-sm"  runat="server" ></asp:TextBox>  
                             <span class="input-group-addon">Net Weight - KG</span>      
                            </div>
                     </div>
                </div> 
                    <div class="form-group">
                  <label  class="col-sm-2 control-label">Packing List- 1</label>  
                  <div class="col-sm-3">  
                  ...
                  <div class="col-sm-2">   
                      ...
                      <asp:TextBox ID="TextNoOfPacking2" style="display:none;" value="0" class="form-control input-sm"  runat="server" ></asp:TextBox>    
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server"   ControlToValidate="TextNoOfPacking1" ErrorMessage="Insert No. Of Pack" Display="Dynamic" SetFocusOnError="True" ValidationGroup="VItemGroup" ></asp:RequiredFieldValidator>
                  </div>
                       <div class="col-sm-2"> 
                         <div class="input-group"> 
                            <asp:TextBox ID="TextNoPerWtPacking1" class="form-control input-sm"  runat="server" ></asp:TextBox>  
                            <asp:TextBox ID="TextNoPerWtPacking2" style="display:none;" value="0" class="form-control input-sm"  runat="server" ></asp:TextBox>  
                             <span class="input-group-addon">KG</span>    
                           </div>  
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server"   ControlToValidate="TextNoPerWtPacking1" ErrorMessage="Insert Per Weight" Display="Dynamic" SetFocusOnError="True" ValidationGroup="VItemGroup" ></asp:RequiredFieldValidator>
                        </div>
                     <div class="col-sm-2"> 
                        <div class="input-group"> 
                            <asp:TextBox ID="TextWtTotalPacking1" class="form-control input-sm"  runat="server" ></asp:TextBox>  
                            <asp:TextBox ID="TextWtTotalPacking2"  style="display:none;" value="0" class="form-control input-sm"  runat="server" ></asp:TextBox>  
                            <span class="input-group-addon">KG</span>      
                         </div>
                      </div>
                </div>
                     <div class="form-group">
                  <label  class="col-sm-2 control-label">Final Net Weight</label> 
                  <div class="col-sm-3">  
                    <div class="input-group"> 
                  ...
                  <div class="form-group">
                    ...
                    <label  class="col-sm-2 control-label">Item (Inventory)</label> 
                  <div class="col-sm-3">   
        ...
        <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Container Summary (Transit-Default)</h3> 
                 <div class="box-tools"> 
    ...
    SelectedRowStyle-BackColor="Yellow"  AutoGenerateColumns="false" ShowHeader="true"  ShowFooter="true" CssClass="table  table-sm table-bordered table-striped"  >
                     ...
                     <asp:BoundField DataField="NUMBER_OF_PACK" HeaderText="Total Bales" DataFormatString="{0:0,0}" ItemStyle-HorizontalAlign="Right" /> 
                     </Columns>
    ...
    OnPageIndexChanging="GridViewEmp_PageIndexChanging" AutoGenerateColumns="false" CssClass="table table-hover table-bordered table-striped" >
                     ...
                     <asp:BoundField DataField="REF_NO" HeaderText="Driver Name" />
