<%@ Page Title="Material Pricing (Overseas) Form & List" Language="C#" MasterPageFile="~/Site.Master" EnableEventValidation="false" AutoEventWireup="true"  CodeBehind="MsExpMaterialPricing.aspx.cs" Inherits="NRCAPPS.MS.MsExpMaterialPricing" %>
    ...
    <script language="javascript" type="text/javascript">
                    ...
                    function GetItemsMs() {    
                                   ...
                                   $("[id*=ctl00_ContentPlaceHolder1_DropDownItemID]").removeAttr("disabled");  
                                    $.ajax({
                                        type: "POST",
                                        url: "MsExpMaterialPricing.aspx/GetItemList",
               ...
               function GetItemDataListWp() {  
                            ...
                            $.ajax({
                                        type: "POST",
                                        url: "MsExpMaterialPricing.aspx/GetSalesItemList",
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-info">
            ...
            <!-- form start --> 
                  ...
                  <div class="col-sm-6">    
                  <asp:DropDownList runat="server" ID="DropDownWpSlipNoEx" class="form-control select2" onchange="GetItemsMs()" > 
                  </asp:DropDownList>  
