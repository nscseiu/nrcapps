<%@ Page Title="Material Transaction Form & List - Metal Scrap" EnableEventValidation="false" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="MsMaterialTransaction.aspx.cs" Inherits="NRCAPPS.MS.MsMaterialTransaction" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
            ...
            <!-- form start -->
              ...
              <div class="box-body"> 
                ...
                <div class="form-group"> 
                  ...
                  <div class="col-sm-4">   
                    <asp:DropDownList ID="DropDownItemID" class="form-control select2 input-sm" runat="server"  onclick="GetMatTransfer()" > 
                    </asp:DropDownList>  
              ...
              <div id="TransferItemBox" style="display:none" runat="server"> 
               <div class="form-group"> 
                  ...
                  <div class="col-sm-4">   
                    <asp:DropDownList ID="DropDownItemTransferID" style="width:100%" class="form-control select2 input-sm" runat="server" > 
                    </asp:DropDownList>  
    ...
    SelectedRowStyle-BackColor="Yellow"  AutoGenerateColumns="false" ShowHeader="true"  ShowFooter="true" CssClass="table  table-sm table-bordered table-striped"  >
                     ...
                     <asp:BoundField DataField="ITEM_NAME_TRANSFER" HeaderText="Transfer Item" ItemStyle-HorizontalAlign="Center" />
                     </Columns>
    ...
    SelectedRowStyle-BackColor="Yellow"   AutoGenerateColumns="false" CssClass="table table-hover table-bordered table-striped" >
                     ...
                     <asp:BoundField DataField="MAT_TRANS_ID" HeaderText="Transaction ID" />
                           <asp:TemplateField>
                       <ItemTemplate>
                        <asp:LinkButton ID="linkSelectClick" class="btn btn-info btn-sm" runat="server" CommandArgument='<%# Eval("MAT_TRANS_ID") %>' OnClick="linkSelectClick" CausesValidation="False">Select</asp:LinkButton> 
                        </ItemTemplate>
                       </asp:TemplateField> 
                       <asp:TemplateField>
                       <ItemTemplate>
                        <asp:LinkButton ID="linkPrintClick" class="btn btn-warning btn-sm" runat="server" CommandArgument='<%# Eval("MAT_TRANS_ID") %>' OnClick="btnPrint_Click" CausesValidation="False">TS Print</asp:LinkButton> 
                        </ItemTemplate>
                       </asp:TemplateField> 
                     <asp:BoundField DataField="TRANSACTION_FOR_NAME" HeaderText="Transaction For" /> 
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"> Material Transaction Statement (Daily Collection Supplier - Month Wise) Parameter</h3>
            </div>
            <!-- /.box-header -->
...
<script language="javascript" type="text/javascript">
    ...
    function GetMatTransfer() {   
        ...
        if (TransactionForID == 3) {
            ...
            $.ajax({
                type: "POST",
                url: "MsMaterialTransaction.aspx/GetItemDataTransferList",
                data: '{"ItemID": "' + ItemID + '"}',
