<%@ Page Title="Party (Supplier & Customer) Form & List - Metal Scrap" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="MsParty.aspx.cs" Inherits="NRCAPPS.MS.MsParty" %>
  ...
  <div class="content-wrapper">
    ...
    SelectedRowStyle-BackColor="Yellow"   AutoGenerateColumns="false"   CssClass="table table-bordered table-striped" >
                     ...
                     <asp:BoundField DataField="PARTY_ID" HeaderText="Party ID" />    
                       <asp:TemplateField>
                           <ItemTemplate>
                            <asp:LinkButton ID="linkSelectClick" class="btn btn-info btn-sm" runat="server" CommandArgument='<%# Eval("PARTY_ID") %>' OnClick="linkSelectClick" CausesValidation="False">Select</asp:LinkButton> 
                            </ItemTemplate>
                       </asp:TemplateField> 
                     ...
                     <asp:TemplateField HeaderText="Enable for Sales" ItemStyle-Width="100">
                        <ItemTemplate> 
