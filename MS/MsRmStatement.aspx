<%@ Page Title="Inventory & Valuation Statement - Metal Scrap" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="MsRmStatement.aspx.cs" Inherits="NRCAPPS.MS.MsRmStatement" %>
      ...
      <div class="row">
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
                    <div class="box-body">       
                           <iframe src="MS_Reports/MsInventoryValuationStatementReportView.aspx?AsOnDate=<%=EntryDate.Text %>&IsReport=1" width="1450px" height="950px" id="iframe1"
         ...
         <!-- /.box -->
            ...
            <!-- /.box-header -->
                    <div class="box-body">       
                           <iframe src="MS_Reports/MsInventoryValuationStatementReportView.aspx?AsOnDate=<%=AsOnDate.Text %>&IsReport=2" width="1450px" height="950px" id="iframe1"
                        marginheight="0" frameborder="0" scrolling="auto" >   </iframe>  
                         </div>
                       </div> 
