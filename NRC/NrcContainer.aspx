<%@ Page Title="Container Form & List - Apps & Data Settings " Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="NrcContainer.aspx.cs" Inherits="NRCAPPS.NRC.NrcContainer" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Container Form & List
        <small>Container: - Add - Update - Delete - View</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Container Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start --> 
              <div class="box-body">
                <div class="form-group">  
                   <label for="TextContainerSize" class="col-sm-2 control-label">Container Size</label>
                 <div class="col-sm-3">  
                    <asp:TextBox ID="TextContainerSizeID" style="display:none" runat="server"></asp:TextBox>
                    <asp:TextBox ID="TextContainerSize" class="form-control input-sm"  runat="server" AutoPostBack="True" ontextchanged="TextContainerSize_TextChanged"></asp:TextBox>  
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                         ControlToValidate="TextContainerSize" ErrorMessage="Insert Container Name" 
                         SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator> 
                  </div> 
                    <div class="col-sm-3"><asp:Label ID="CheckContainerSize" runat="server"></asp:Label> 
                    </div>
                </div>
                <div class="form-group">  
                   <label for="TextContainerSizeInwords" class="col-sm-2 control-label">Container Size Inwords</label>
                 <div class="col-sm-3">   
                    <asp:TextBox ID="TextContainerSizeInwords" class="form-control input-sm"  runat="server"></asp:TextBox>   
                  </div>  
                </div> 
                <div class="form-group">
    ...
    SelectedRowStyle-BackColor="Yellow"   AutoGenerateColumns="false"   CssClass="table table-bordered table-striped" >
                     <Columns>
                     <asp:BoundField DataField="CONTAINER_SIZE_ID" HeaderText="Container Size ID" />  
                     <asp:BoundField DataField="CONTAINER_SIZE"  HeaderText="Container Size" /> 
                     <asp:BoundField DataField="CONTAINER_SIZE_INWORDS"  HeaderText="Container Size In Words" />                                
                     ...
                     <asp:TemplateField>
                       <ItemTemplate>
                        <asp:LinkButton ID="linkSelectClick" class="btn btn-info btn-xs" runat="server" CommandArgument='<%# Eval("CONTAINER_SIZE_ID") %>' OnClick="linkSelectClick" CausesValidation="False">Select</asp:LinkButton> 
                        </ItemTemplate>
                       </asp:TemplateField> 
                     </Columns>
