<%@ Page Title="Shipping Incoterms Form & List - Apps & Data Settings " Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="NrcShippingIncoterms.aspx.cs" Inherits="NRCAPPS.NRC.NrcShippingIncoterms" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Shipping Incoterms Form & List
        <small>Shipping Incoterms: - Add - Update - Delete - View</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="../Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Apps & Data Settings</a></li>
        <li class="active">Shipping Incoterms</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Shipping Incoterms Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start --> 
              <div class="box-body">
                <div class="form-group">  
                   <label for="TextShippingInco" class="col-sm-2 control-label">Shipping Incoterms </label>
                 <div class="col-sm-3">  
                    <asp:TextBox ID="TextShippingIncoID" style="display:none" runat="server"></asp:TextBox>
                    <asp:TextBox ID="TextShippingInco" class="form-control input-sm"  runat="server" AutoPostBack="True" ontextchanged="TextShippingInco_TextChanged"></asp:TextBox>  
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                         ControlToValidate="TextShippingInco" ErrorMessage="Insert Shipping Incoterms Name" 
                         SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator> 
                  </div> 
                    <div class="col-sm-3"><asp:Label ID="CheckShippingInco" runat="server"></asp:Label> 
                    </div>
                </div>
                <div class="form-group">  
                   <label for="TextShippingIncoDetails" class="col-sm-2 control-label">Shipping Incoterms Details</label>
                 <div class="col-sm-3">   
                    <asp:TextBox ID="TextShippingIncoDetails" class="form-control input-sm"  runat="server"></asp:TextBox>   
                  </div>  
                </div> 
                <div class="form-group">
        ...
        <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Shipping Incoterms List</h3>
              <div class="box-tools">
    ...
    SelectedRowStyle-BackColor="Yellow"   AutoGenerateColumns="false"   CssClass="table table-bordered table-striped" >
                     <Columns>
                     <asp:BoundField DataField="SHIPPING_INCO_ID" HeaderText="Shipping Incoterms ID" />  
                     <asp:BoundField DataField="SHIPPING_INCO_NAME"  HeaderText="Shipping Incoterms" /> 
                     <asp:BoundField DataField="SHIPPING_INCO_DETAILS"  HeaderText="Shipping Incoterms In Words" />                                
                     ...
                     <asp:TemplateField>
                       <ItemTemplate>
                        <asp:LinkButton ID="linkSelectClick" class="btn btn-info btn-xs" runat="server" CommandArgument='<%# Eval("SHIPPING_INCO_ID") %>' OnClick="linkSelectClick" CausesValidation="False">Select</asp:LinkButton> 
                        </ItemTemplate>
                       </asp:TemplateField> 
                     </Columns>
