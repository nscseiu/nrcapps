<%@ Page Title="Trading Vessel Form & List - Apps & Data Settings " Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="NrcTradingVessel.aspx.cs" Inherits="NRCAPPS.NRC.NrcTradingVessel" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Trading Vessel Form & List
        <small>Trading Vessel: - Add - Update - Delete - View</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="../Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Apps & Data Settings</a></li>
        <li class="active">Trading Vessel</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Trading Vessel Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start --> 
              <div class="box-body">
                <div class="form-group">  
                   <label for="TextTradingVessel" class="col-sm-2 control-label">Trading Vessel </label>
                 <div class="col-sm-3">  
                    <asp:TextBox ID="TextTradingVesselID" style="display:none" runat="server"></asp:TextBox>
                    <asp:TextBox ID="TextTradingVessel" class="form-control input-sm"  runat="server" AutoPostBack="True" ontextchanged="TextTradingVessel_TextChanged"></asp:TextBox>  
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                         ControlToValidate="TextTradingVessel" ErrorMessage="Insert Trading Vessel Name" 
                         SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator> 
                  </div> 
                    <div class="col-sm-3"><asp:Label ID="CheckTradingVessel" runat="server"></asp:Label> 
                    </div>
                </div>
                <div class="form-group">  
                   <label for="TextTradingVesselDetails" class="col-sm-2 control-label">Trading Vessel Details</label>
                 <div class="col-sm-3">   
                    <asp:TextBox ID="TextTradingVesselDetails" class="form-control input-sm"  runat="server"></asp:TextBox>   
                  </div>  
                </div> 
                <div class="form-group">
        ...
        <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Trading Vessel List</h3>
              <div class="box-tools">
    ...
    SelectedRowStyle-BackColor="Yellow"   AutoGenerateColumns="false"   CssClass="table table-bordered table-striped" >
                     <Columns>
                     <asp:BoundField DataField="TRADING_VESSEL_ID" HeaderText="Trading Vessel ID" />  
                     <asp:BoundField DataField="TRADING_VESSEL_NAME"  HeaderText="Trading Vessel" /> 
                     <asp:BoundField DataField="TRADING_VESSEL_DETAILS"  HeaderText="Trading Vessel In Words" />                                
                     ...
                     <asp:TemplateField>
                       <ItemTemplate>
                        <asp:LinkButton ID="linkSelectClick" class="btn btn-info btn-xs" runat="server" CommandArgument='<%# Eval("TRADING_VESSEL_ID") %>' OnClick="linkSelectClick" CausesValidation="False">Select</asp:LinkButton> 
                        </ItemTemplate>
                       </asp:TemplateField> 
                     </Columns>
