          ...
          <div class="box box-info">
            ...
            <!-- form start -->
              ...
              <div class="form-group">
                ...
                <div class="form-group"> 
                 ...
                 <div class="col-sm-2">  
                    ...
                    <asp:TextBox ID="TextUserName" class="form-control input-sm" placeholder="User Name"  runat="server" AutoCompleteType="Disabled" AutoPostBack="True" 
                ...
                <div id="ChangeOpen" runat="server" >  
                 <div class="form-group">
                  <label  class="col-sm-2 control-label"> Is Password</label> 
                  <div class="col-sm-3"> 
                    <asp:RadioButtonList ID="radPassChange" runat="server" AutoPostBack = "true"  onselectedindexchanged="Redio_CheckedChanged" RepeatDirection="Horizontal">
                         <asp:ListItem Value="Not_Change" Selected="True">Not Change &nbsp;</asp:ListItem>
              ...
              <div class="form-group has-feedback">
                  ...
                  <div class="col-sm-2">  
                    <asp:TextBox ID="TextPassword"  class="form-control input-sm" placeholder="Password" runat="server" AutoCompleteType="Disabled"  onmousedown="this.type='text'" onmouseup="this.type='password'" onmousemove="this.type='password'" ></asp:TextBox> 
