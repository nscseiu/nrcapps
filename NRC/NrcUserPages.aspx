<%@ Page Title="User Pages Form & List" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="NrcUserPages.aspx.cs" Inherits="NRCAPPS.NRC.NrcUserPages" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        User Pages Form & List
        <small>User Pages: - Add - Update - Delete - View</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">User Page Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body">
               <div class="form-group">
                  <label  class="col-sm-2 control-label">Under The Main Menu</label> 
                  <div class="col-sm-3">   
                    <asp:DropDownList ID="DropDownMainMenuID" class="form-control input-sm" runat="server"> 
                    </asp:DropDownList>  
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
                          ControlToValidate="DropDownMainMenuID" Display="Dynamic" 
                          ErrorMessage="Select Main Menu" InitialValue="0" SetFocusOnError="True"></asp:RequiredFieldValidator>
                  </div>
                </div> 
                <div class="form-group"> 
                   <label for="User_Name" class="col-sm-2 control-label">User Page Name</label>
                 <div class="col-sm-3">  
                    <asp:TextBox ID="TextUserPageID" style="display:none" runat="server"></asp:TextBox>
                    <asp:TextBox ID="TextUserPageName" class="form-control input-sm"  runat="server" ></asp:TextBox>  
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                         ControlToValidate="TextUserPageName" ErrorMessage="Insert User Role Name" 
                         SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator> 
                  </div> 
                    
                </div>
                <div class="form-group">
                  <label  class="col-sm-2 control-label">User Page Url</label> 
                  <div class="col-sm-3">  
                    <asp:TextBox ID="TextUserPageUrl" class="form-control input-sm"  runat="server" AutoPostBack="True" 
                        ontextchanged="TextUserRoleSName_TextChanged"></asp:TextBox>   
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                          ControlToValidate="TextUserPageName" ErrorMessage="Insert Role Short name" 
                          Display="Dynamic"></asp:RequiredFieldValidator>
                  </div>
                    <div class="col-sm-3"><asp:Label ID="CheckUserPageName" runat="server"></asp:Label> 
                    </div>
                </div> 
                <div class="form-group">
        ...
        <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">User Page List</h3>
              <div class="box-tools">
    ...
    OnPageIndexChanging="GridViewUser_PageIndexChanging" AutoGenerateColumns="false"   CssClass="table table-bordered table-striped" >
                     ...
                     <asp:TemplateField>
                       <ItemTemplate>
                        <asp:LinkButton ID="linkSelectClick" class="btn btn-info btn-xs" runat="server" CommandArgument='<%# Eval("USER_PAGE_ID") %>' OnClick="linkSelectClick" CausesValidation="False">Select</asp:LinkButton> 
                        </ItemTemplate>
                       </asp:TemplateField> 
                     </Columns>
