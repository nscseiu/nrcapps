<%@ Page Title="Actual Garbage Form & List - Plastic Factory" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="PfActualGarbage.aspx.cs" Inherits="NRCAPPS.PF.PfActualGarbage" %>
            ...
            <!-- form start --> 
              <div class="box-body">
                 <div class="form-group">
                  ...
                  <div class="form-group">
                  <label  class="col-sm-2 control-label">Actual Garbage</label> 
                  <div class="col-sm-2">  
