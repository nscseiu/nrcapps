...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
            ...
            <!-- form start --> 
              <div class="box-body">
                 <div class="form-group">
                  ...
                  <div class="form-group">
                  <label  class="col-sm-3 control-label">Item Target for Purchases</label> 
                  <div class="col-sm-2">  
                ...
                <div class="form-group">
                  <label  class="col-sm-3 control-label">Item Target for Production</label> 
                  <div class="col-sm-2">  
                   <div class="input-group"> 
    ...
    OnPageIndexChanging="GridViewUser_PageIndexChanging" AutoGenerateColumns="false"   CssClass="table table-bordered table-striped" >
                     ...
                     <asp:BoundField DataField="ITEM_WEIGHT_PUR"  HeaderText="Target for Purchase - WT - MT" DataFormatString="{0:0.00}" /> 
                     <asp:BoundField DataField="ITEM_WEIGHT_PROD"  HeaderText="Target for Production - WT - MT" DataFormatString="{0:0.00}" />                        
