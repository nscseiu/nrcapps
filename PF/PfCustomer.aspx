<%@ Page Title="Customer Form & List - Plastic Factory" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="PfCustomer.aspx.cs" Inherits="NRCAPPS.PF.PfCustomer" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Customer Form & List
        <small>Customer: - Add - Update - Delete - View</small>
      </h1>
      <ol class="breadcrumb">
            ...
            <!-- form start --> 
              <div class="box-body">
                <div class="form-group">  
                   <label for="User_Name" class="col-sm-2 control-label">Customer Name</label>
                 <div class="col-sm-3">  
                    <asp:TextBox ID="TextCustomerID" style="display:none" runat="server"></asp:TextBox>
                    <asp:TextBox ID="TextCustomerName" class="form-control input-sm"  runat="server" AutoPostBack="True" ontextchanged="TextCustomerName_TextChanged"></asp:TextBox>  
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                         ControlToValidate="TextCustomerName" ErrorMessage="Insert Customer Name" 
                         SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator> 
                  </div> 
                    <div class="col-sm-3"><asp:Label ID="CheckCustomerName" runat="server"></asp:Label> 
                    </div>
                </div>
                <div class="form-group">
                  <label  class="col-sm-2 control-label">Customer Address Line 1</label> 
                  <div class="col-sm-3">  
                    <asp:TextBox ID="TextCus_Add_1" class="form-control input-sm"  runat="server"></asp:TextBox>   
                      
                  </div> 
                </div> 
                <div class="form-group">
                  <label  class="col-sm-2 control-label">Customer Address Line 2</label> 
                  <div class="col-sm-3">  
                    <asp:TextBox ID="TextCus_Add_2" class="form-control input-sm"  runat="server"></asp:TextBox>   
    ...
    OnPageIndexChanging="GridViewUser_PageIndexChanging" AutoGenerateColumns="false"   CssClass="table table-bordered table-striped" >
                     ...
                     <asp:BoundField DataField="CUS_ADD_1"  HeaderText="Customer Add. Line 1" /> 
                     <asp:BoundField DataField="CUS_ADD_2"  HeaderText="Customer Add. Line 2" /> 
                     ...
                     <asp:TemplateField>
                       <ItemTemplate>
                        <asp:LinkButton ID="linkSelectClick" class="btn btn-info btn-xs" runat="server" CommandArgument='<%# Eval("CUSTOMER_ID") %>' OnClick="linkSelectClick" CausesValidation="False">Select</asp:LinkButton> 
                        </ItemTemplate>
                       </asp:TemplateField> 
                     </Columns>
