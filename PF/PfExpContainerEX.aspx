<%@ Page Title="Weight Slip & Container Form & List - Plastic Factory" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="PfExpContainerEX.aspx.cs" Inherits="NRCAPPS.PF.PfExpContainerEX" %>
  ...
  <div class="content-wrapper">
            ...
            <!-- form start -->
              ...
              <div class="box-body"> 
                ...
                <div class="form-group">   
                    <label class="col-sm-4 control-label">Weight Slip No</label> 
                   <div class="col-sm-3">  
                    <asp:TextBox ID="TextExWbConID" class="form-control input-sm" style="display:none"  runat="server"></asp:TextBox> 
                    <asp:TextBox ID="TextSlipWbNo" class="form-control input-sm" style="display:none"  runat="server"></asp:TextBox>    
               ...
               <div class="form-group">
                  <label  class="col-sm-4 control-label"> Seal No.</label> 
                  <div class="col-sm-4">   
               ...
               <div class="form-group">
                  <label  class="col-sm-4 control-label"> Release Order No.</label> 
                  <div class="col-sm-4">   
                ...
                <div class="form-group">
                  <label  class="col-sm-4 control-label"> Item WT Weigh-Bridge</label> 
                  <div class="col-sm-4">  
                ...
                <div class="form-group">
                  <label  class="col-sm-4 control-label">Salesman Name</label> 
                  <div class="col-sm-5">   
                      ...
                      <div class="col-sm-6"> 
                         <div class="input-group"> 
                            <asp:TextBox ID="TextItemWeightWBEx" class="form-control input-sm"  runat="server" ></asp:TextBox>  
                             <span class="input-group-addon">Weigh Bridge Balance - KG</span>      
                            </div>
                     </div>
                </div>  
                  <div class="form-group">
                  ...
                  <div class="col-sm-3">  
                   ...
                   <div class="col-sm-3"> 
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator24" runat="server" 
                          ControlToValidate="DropDownItemID" Display="Dynamic" 
                          ErrorMessage="Select Sub Item" InitialValue="0" SetFocusOnError="True" ValidationGroup="VItemGroup" ></asp:RequiredFieldValidator>
                     </div> 
                </div> 
                <div class="form-group">
                  <label  class="col-sm-3 control-label">No. of Bags & Per WT</label> 
                  <div class="col-sm-3">   
                      <asp:TextBox ID="TextNoOfBags" class="form-control input-sm"  runat="server" ></asp:TextBox>    
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server"   ControlToValidate="TextNoOfBags" ErrorMessage="Insert No. Of Bags" Display="Dynamic" SetFocusOnError="True" ValidationGroup="VItemGroup" ></asp:RequiredFieldValidator>
                  </div>
                       <div class="col-sm-3"> 
                         <div class="input-group"> 
                            <asp:TextBox ID="TextBagsPerWt" class="form-control input-sm"  runat="server" ></asp:TextBox>  
                             <span class="input-group-addon">KG</span>    
                           </div>  
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server"   ControlToValidate="TextBagsPerWt" ErrorMessage="Insert No. Of Bags" Display="Dynamic" SetFocusOnError="True" ValidationGroup="VItemGroup" ></asp:RequiredFieldValidator>
                        </div>
                     <div class="col-sm-3"> 
                        <div class="input-group"> 
                            <asp:TextBox ID="TextBagsPerWtTotal" class="form-control input-sm"  runat="server" ></asp:TextBox>  
                            <span class="input-group-addon">KG</span>      
                         </div>
                    </div>
                </div>
                <div class="form-group">
                  <label  class="col-sm-3 control-label">No. of Wood Pall. & Per WT</label> 
                  <div class="col-sm-3">   
                      <asp:TextBox ID="TextNoOfWoodPall" class="form-control input-sm"  runat="server" ></asp:TextBox>    
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server"   ControlToValidate="TextNoOfWoodPall" ErrorMessage="Insert No. Of Wood Pall." Display="Dynamic" SetFocusOnError="True" ValidationGroup="VItemGroup"  ></asp:RequiredFieldValidator>
                  </div>
                     <div class="col-sm-3"> 
                         <div class="input-group"> 
                            <asp:TextBox ID="TextWoodPallPerWt" class="form-control input-sm"  runat="server" ></asp:TextBox>  
                             <span class="input-group-addon">KG</span>      
                            </div> 
                         <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server"   ControlToValidate="TextWoodPallPerWt" ErrorMessage="Insert WT Of Wood Pall." Display="Dynamic" SetFocusOnError="True" ValidationGroup="VItemGroup"  ></asp:RequiredFieldValidator>
                       </div>
                     <div class="col-sm-3"> 
                         <div class="input-group"> 
                            <asp:TextBox ID="TextWoodPallPerWtTotal" class="form-control input-sm"  runat="server" ></asp:TextBox>  
                             <span class="input-group-addon">KG</span>      
                            </div>
                     </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="input-group"> 
                    ...
                    <span class="input-group-addon">KG</span>      
                     ...
                     <asp:RegularExpressionValidator ID="RequiredFieldValidator25" runat="server" ErrorMessage="Weight must be greater than 0." ControlToValidate="TextItemWeightEx" ValidationExpression="^[1-9][0-9]*$" SetFocusOnError="true" ValidationGroup="VItemGroup" >
    ...
    OnPageIndexChanging="GridViewEmp_PageIndexChanging" AutoGenerateColumns="false" CssClass="table table-hover table-bordered table-striped" >
                    ...
                    <asp:TemplateField HeaderText="Container No." ItemStyle-Width="100" ItemStyle-HorizontalAlign="Center">
                     ...
                     <asp:TemplateField HeaderText="Is Inventory Status" > 
                        <ItemTemplate> 
                     ...
                     <asp:TemplateField HeaderText="Is Print" ItemStyle-Width="100" ItemStyle-HorizontalAlign="Center">
                      ...
                      <asp:TemplateField HeaderText="Is Container Shipment" ItemStyle-Width="100">
                        <ItemTemplate> 
                     ...
                     <asp:BoundField DataField="WET_PER_BAG"  HeaderText="Per Bags WT"   />   
                     <asp:BoundField DataField="TOTAL_BAG_WT"  HeaderText="Total Bags WT"   />  
                     <asp:BoundField DataField="TOTAL_WP_WT"  HeaderText="Total Bags WT"   />                         
                     <asp:BoundField DataField="NO_OF_WOOD_PALLETS"  HeaderText="No of Wood Pall."   /> 
                     <asp:BoundField DataField="WET_PER_WP"  HeaderText="Per Wood Pall"   />                          
                     
                     <asp:TemplateField>
                       <ItemTemplate>
                        <asp:LinkButton ID="linkSelectItemClick" class="btn btn-info btn-xs" runat="server" CommandArgument='<%# Eval("EXP_WBCON_ITEM_ID") %>' OnClick="linkSelectItemClick" CausesValidation="False">Select</asp:LinkButton> 
                        </ItemTemplate>
                       </asp:TemplateField> 
                     </Columns>
                        <PagerStyle CssClass="pagination-ys" />
