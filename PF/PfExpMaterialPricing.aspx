<%@ Page Title="Material Pricing (Overseas) Form & List" Language="C#" MasterPageFile="~/Site.Master" EnableEventValidation="false" AutoEventWireup="true"  CodeBehind="PfExpMaterialPricing.aspx.cs" Inherits="NRCAPPS.PF.PfExpMaterialPricing" %>
    ...
    <script language="javascript" type="text/javascript">
               ...
               function GetItemDataListWp() {   
                         var Item_Wt = $("#ctl00_ContentPlaceHolder1_DropDownSlipNoEx").val().split('-');
                            ...
                            $.ajax({
                                        type: "POST",
                                        url: "PfExpMaterialPricing.aspx/GetSalesItemList",
