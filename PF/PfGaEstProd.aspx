<%@ Page Title="Garbage Estimation Percent of Production Form & List - Plastic Factory" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="PfGaEstProd.aspx.cs" Inherits="NRCAPPS.PF.PfGaEstProd" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Garbage Estimation Percent of Production From & List
        <small>Garbage Estimation Percent of Production: - Add - Update - Delete - View</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="../Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Plastic Factory</a></li>
        <li class="active">Garbage Estimation Percent of Production</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Garbage Estimation Percent of Production Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start --> 
              <div class="box-body">
                <div class="form-group">  
                   <label for="User_Name" class="col-sm-2 control-label">Garbage Estimation Percent of Production</label>
                 <div class="col-sm-2">  
                 <div class="input-group"> 
                    <asp:TextBox ID="TextProGarEstID" style="display:none" runat="server"></asp:TextBox>
                    <asp:TextBox ID="TextProGarEstName" class="form-control input-sm"  runat="server" AutoPostBack="True" ontextchanged="TextProGarEstName_TextChanged"></asp:TextBox>  
                     <span class="input-group-addon">%</span>      
                    </div>
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                         ControlToValidate="TextProGarEstName" ErrorMessage="Insert Machine Name" 
        ...
        <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Garbage Estimation Percent of Production List</h3>
              <div class="box-tools">
    ...
    OnPageIndexChanging="GridViewUser_PageIndexChanging" AutoGenerateColumns="false"   CssClass="table table-bordered table-striped" >
                     <Columns>
                     <asp:BoundField DataField="PGE_ID" HeaderText="GE of Prod. ID" />  
                     <asp:BoundField DataField="PGE_PERCENT"  HeaderText="GE of Prod. Percent" />    
                     ...
                     <asp:TemplateField>
                       <ItemTemplate>
                        <asp:LinkButton ID="linkSelectClick" class="btn btn-info btn-xs" runat="server" CommandArgument='<%# Eval("PGE_ID") %>' OnClick="linkSelectClick" CausesValidation="False">Select</asp:LinkButton> 
                        </ItemTemplate>
                       </asp:TemplateField> 
                     </Columns>
