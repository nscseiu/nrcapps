  ...
  <div class="content-wrapper">
    ...
    OnPageIndexChanging="GridViewUser_PageIndexChanging" AutoGenerateColumns="false"   CssClass="table table-hover table-bordered table-striped" >
        ...
        <!--/.col (right) -->
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Inventory Finished Goods Monthly History Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start --> 
              <div class="box-body">
                ...
                <div class="form-group">
                  <label  class="col-sm-5 control-label">Item</label> 
                  <div class="col-sm-4">   
                   <asp:TextBox ID="TextInventoryFgHisID" style="display:none" runat="server"></asp:TextBox>
        ...
        <div class="box box-warning">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Inventory Finished Goods History List</h3>
              <div class="box-tools">
              <div class="input-group input-group-sm" style="width: 200px;">
    ...
    OnPageIndexChanging="GridViewHistory_PageIndexChanging" AutoGenerateColumns="false"   CssClass="table table-hover table-bordered table-striped" >
                     ...
                     <asp:BoundField DataField="ITEM_AVG_RATE"  HeaderText="AVG. Rate"  DataFormatString="{0:0.00}" ItemStyle-HorizontalAlign="Right"  />  
                      <asp:TemplateField>
                       <ItemTemplate>
                        <asp:LinkButton ID="linkSelectFgHisClick" class="btn btn-info btn-xs" runat="server" CommandArgument='<%# Eval("IN_FG_HIS_ID") %>' OnClick="linkSelectFgHisClick" CausesValidation="False">Select</asp:LinkButton> 
                        </ItemTemplate>
                       </asp:TemplateField>  
                     </Columns>
                        <PagerStyle CssClass="pagination-ys" />
