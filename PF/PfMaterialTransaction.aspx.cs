        ...
        public void BtnAdd_Click(object sender, EventArgs e)
        {
         ...
         //     { 
                ...
                else if (TransactionForID == 2)
                {
                    ...
                    cmdsp = new OracleCommand(get_id, conn);
                    int newTransactionID = Int32.Parse(cmdsp.ExecuteScalar().ToString());
                    string insert_trans = "insert into  PF_MATERIAL_TRANSACTION (MAT_TRANS_ID, TRANSACTION_FOR_ID, ITEM_ID, ITEM_WEIGHT, ITEM_TRANSFER_ID, ENTRY_DATE, REMARKS, CREATE_DATE, C_USER_ID, IS_ACTIVE) values  ('TR-' || LPAD(:NoTransactionID, 6, '0') , :NoTransactionForID, :NoItemID, :NoItemWeight, :NoItemTransferID, TO_DATE(:EntryDate, 'DD/MM/YYYY'), :TextRemarks, TO_DATE(:c_date, 'DD-MM-YYYY HH:MI:SS AM'), :NoCuserID, :TextIsActive)";
                    cmdi = new OracleCommand(insert_trans, conn);
