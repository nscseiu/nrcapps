<%@ Page Title="Material Transaction Form & List - Plastic Factory" EnableEventValidation="false" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="PfMaterialTransactionNew.aspx.cs" Inherits="NRCAPPS.PF.PfMaterialTransactionNew" %>
  ...
  <div class="content-wrapper">
    ...
    SelectedRowStyle-BackColor="Yellow"   AutoGenerateColumns="false" CssClass="table table-hover table-bordered table-striped" >
         ...
         <!-- /.box -->
            ...
            <!-- /.box-header -->
                    <div class="box-body">       
                           <iframe src="WP_Reports/PfPurchaseSupplierWiseReportView.aspx?MonthYear=<%=TextMonthYear0.Text %>&SupplierID=<%=DropDownSupplierID2.Text %>" width="950px" id="iframe1"
            ...
            <!-- form start -->   
              <div class="form-group">
                  ...
                  <div class="col-sm-2">   
                    <asp:DropDownList ID="DropDownDriverID2" class="form-control input-sm" runat="server"> 
                    </asp:DropDownList>  
         ...
         <!-- /.box -->
            ...
            <!-- /.box-header -->
                    <div class="box-body">       
                           <iframe src="PF_Reports/PfPurchaseSummaryReportView.aspx?MonthYear=<%=TextMonthYear1.Text %>&PurchaseTypeID=<%=DropDownDriverID2.Text %>" width="950px" id="iframe2"
                        marginheight="0" frameborder="0" scrolling="auto" height="1250px">   </iframe>  
                         </div>
                       </div> 
