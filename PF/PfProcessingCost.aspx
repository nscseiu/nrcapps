<%@ Page Title="Processing Cost Form & List - Plastic Factory" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="PfProcessingCost.aspx.cs" Inherits="NRCAPPS.PF.PfProcessingCost" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
            ...
            <!-- form start --> 
              <div class="box-body">
                 <div class="form-group">
                  ...
                  <div class="form-group">
                  <label  class="col-sm-2 control-label">Item Cost Rate</label> 
                  <div class="col-sm-2">  
                   <div class="input-group"> 
                    <asp:TextBox ID="TextItemCostRate" class="form-control input-sm"  runat="server"  ></asp:TextBox>   
                    <span class="input-group-addon">.00</span>      
                    </div> 
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" 
                          ControlToValidate="TextItemCostRate" ErrorMessage="insert Item Cost Rate" 
    ...
    OnPageIndexChanging="GridViewUser_PageIndexChanging" AutoGenerateColumns="false"   CssClass="table table-bordered table-striped" >
                     ...
                     <asp:BoundField DataField="COST_RATE"  HeaderText="Cost Rate" DataFormatString="{0:0.00}" />   
