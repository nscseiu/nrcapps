<%@ Page Title="Job Work - Purchase Form & List - Plastic Factory" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="PfPurchaseJw.aspx.cs" Inherits="NRCAPPS.PF.PfPurchaseJw" %>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Job Work (Purchase) Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body">
                <div class="form-group">   
                  ...
                  <div class="col-sm-3"><asp:Label ID="CheckSlipNo" runat="server"></asp:Label></div>  
               </div>
               <div class="form-group">
                  <label  class="col-sm-2 control-label">Supplier Name</label> 
                  <div class="col-sm-3">   
                    <asp:DropDownList ID="DropDownSupplierID" class="form-control input-sm" runat="server"> 
                    </asp:DropDownList>  
        ...
        <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Job Work (Purchase) List</h3>
              <div class="box-tools">
              <div class="col-sm-5">   
