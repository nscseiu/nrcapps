<%@ Page Title="Purchase Type Form & List - Plastic Factory" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="PfPurchaseType.aspx.cs" Inherits="NRCAPPS.PF.PfPurchaseType" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Purchase Type Form & List
        <small>Purchase Type: - Add - Update - Delete - View</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">PurchaseType Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start --> 
              <div class="box-body">
                <div class="form-group">  
                   <label for="User_Name" class="col-sm-2 control-label">Purchase Type Name</label>
                 <div class="col-sm-3">  
                    <asp:TextBox ID="TextPurchaseTypeID" style="display:none" runat="server"></asp:TextBox>
                    <asp:TextBox ID="TextPurchaseTypeName" class="form-control input-sm"  runat="server" AutoPostBack="True" ontextchanged="TextPurchaseTypeName_TextChanged"></asp:TextBox>  
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                         ControlToValidate="TextPurchaseTypeName" ErrorMessage="Insert PurchaseType Name" 
                         SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator> 
                  </div> 
                    <div class="col-sm-3"><asp:Label ID="CheckPurchaseTypeName" runat="server"></asp:Label> 
                    </div>
                </div>
    ...
    OnPageIndexChanging="GridViewUser_PageIndexChanging" AutoGenerateColumns="false"   CssClass="table table-bordered table-striped" >
                     <Columns>
                     <asp:BoundField DataField="PUR_TYPE_ID" HeaderText="Purchase Type ID" />  
                     <asp:BoundField DataField="PUR_TYPE_NAME"  HeaderText="Purchase Type Name" />    
                     ...
                     <asp:TemplateField>
                       <ItemTemplate>
                        <asp:LinkButton ID="linkSelectClick" class="btn btn-info btn-xs" runat="server" CommandArgument='<%# Eval("PUR_TYPE_ID") %>' OnClick="linkSelectClick" CausesValidation="False">Select</asp:LinkButton> 
                        </ItemTemplate>
                       </asp:TemplateField> 
                     </Columns>
