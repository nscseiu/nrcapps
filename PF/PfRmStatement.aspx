<%@ Page Title="Raw Material Statement - Plastic Factory" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="PfRmStatement.aspx.cs" Inherits="NRCAPPS.PF.PfRmStatement" %>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Raw Material Statement: - View</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="../Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Plastic Factory</a></li>
        <li class="active">Raw Material Statement</li>
      </ol>
    </section>
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Raw Material Statement Parameter</h3>
            </div>
            <!-- /.box-header -->
         ...
         <!-- /.box -->
            ...
            <div class="box-header with-border">
              <h3 class="box-title"> Raw Material Report View</h3>
            </div> 
            <!-- /.box-header -->
                    <div class="box-body">       
