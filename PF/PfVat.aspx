<%@ Page Title="Vat Form & List - Plastic Factory" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeFile="PfVat.aspx.cs" Inherits="NRCAPPS.PF.PfVat" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Vat From & List
        <small>Vat: - Add - Update - Delete - View</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Vat Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start --> 
              <div class="box-body">
                <div class="form-group">  
                   <label for="User_Name" class="col-sm-2 control-label">Vat Percent</label>
                 <div class="col-sm-1">  
                 <div class="input-group"> 
                    <asp:TextBox ID="TextVatID" style="display:none" runat="server"></asp:TextBox>
                    <asp:TextBox ID="TextVatPercent" class="form-control input-sm"  runat="server" AutoPostBack="True" ontextchanged="TextVatPercent_TextChanged"></asp:TextBox>  
                     <span class="input-group-addon">%</span>      
                    </div>
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                         ControlToValidate="TextVatPercent" ErrorMessage="Insert Vat Percentage" SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator> 
                  </div> 
    ...
    OnPageIndexChanging="GridViewUser_PageIndexChanging" AutoGenerateColumns="false"   CssClass="table table-bordered table-striped" >
                     <Columns>
                     <asp:BoundField DataField="VAT_ID" HeaderText="Vat ID" />  
                     <asp:BoundField DataField="VAT_PERCENT"  HeaderText="Vat Percent" />    
                     ...
                     <asp:TemplateField>
                       <ItemTemplate>
                        <asp:LinkButton ID="linkSelectClick" class="btn btn-default btn-xs" runat="server" CommandArgument='<%# Eval("VAT_ID") %>' OnClick="linkSelectClick" CausesValidation="False">Select</asp:LinkButton> 
                        </ItemTemplate>
                       </asp:TemplateField> 
                     </Columns>
