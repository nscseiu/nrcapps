            ...
            <!-- form start -->
              ...
              <div class="box-body">
               ...
               <div class="form-group">
                  ...
                  <div class="form-group">
                  <label  class="col-sm-4 control-label">Machine Number</label> 
                  <div class="col-sm-5">   
                ...
                <div class="form-group">
                  <label  class="col-sm-4 control-label">Supervisor Name</label> 
                  <div class="col-sm-5">   
                ...
                <div class="form-group">
                  <label  class="col-sm-4 control-label">Item Weight</label> 
                  <div class="col-sm-3"> 
                ...
                <div class="form-group">
                  <label  class="col-sm-4 control-label">Garbage Est. of Production</label> 
                  <div class="col-sm-3">  
                   <div class="input-group"> 
                  ...
                  <label  class="col-sm-4 control-label">Garbage Est. of Prod. Weight</label> 
                  <div class="col-sm-3">   
                    <div class="input-group"> 
