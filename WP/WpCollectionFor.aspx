<%@ Page Title="Collection For Form & List - Waste Paper" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="WpCollectionFor.aspx.cs" Inherits="NRCAPPS.WP.WpCollectionFor" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
         Collection For Form & List
        <small> Collection For: - Add - Update - Delete - View</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="../Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Waste Paper</a></li>
        <li class="active"> Collection For</li>
      </ol>
    </section>
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"> Collection For Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start --> 
              <div class="box-body">
                <div class="form-group">  
                   <label for="User_Name" class="col-sm-2 control-label"> Collection For Name</label>
                 <div class="col-sm-3">  
                    <asp:TextBox ID="TextCollectionID" style="display:none" runat="server"></asp:TextBox>
                    <asp:TextBox ID="TextCollectionName" class="form-control input-sm"  runat="server" AutoPostBack="True" ontextchanged="TextCollectionName_TextChanged"></asp:TextBox>  
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                         ControlToValidate="TextCollectionName" ErrorMessage="Insert Procurement Collection Name" 
                         SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator> 
                  </div> 
                    <div class="col-sm-3"><asp:Label ID="CheckCollectionName" runat="server"></asp:Label> 
                    </div>
                </div>
    ...
    OnPageIndexChanging="GridViewUser_PageIndexChanging" AutoGenerateColumns="false"   CssClass="table table-bordered table-striped" >
                     <Columns>
                     <asp:BoundField DataField="COLLECTION_FOR_ID" HeaderText="Collection ID" />  
                     <asp:BoundField DataField="COLLECTION_FOR_NAME"  HeaderText="Collection For Name" />    
                     ...
                     <asp:TemplateField>
                       <ItemTemplate>
                        <asp:LinkButton ID="linkSelectClick" class="btn btn-info btn-xs" runat="server" CommandArgument='<%# Eval("COLLECTION_FOR_ID") %>' OnClick="linkSelectClick" CausesValidation="False">Select</asp:LinkButton> 
                        </ItemTemplate>
                       </asp:TemplateField> 
                     </Columns>
