<%@ Page Title="Sales Invoice (Overseas) Form & List" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="WpExpSalesInvoice.aspx.cs" Inherits="NRCAPPS.WP.WpExpSalesInvoice" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Sales Invoice (Overseas) Form & List
        <small>Sales Invoice (Overseas): - Add - Update - Delete</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Sales Invoice (Overseas) Form</h3>
                <div class="box-tools">
                      <div class="col-sm-4">  
                      ...
                      <div class="col-sm-1">  
                       <asp:LinkButton ID="btnPrint" class="btn btn-warning"  runat="server" OnClick="btnPrint_Click" ><span class="fa fa-print"></span> Sales Invoice (Overseas) Print</asp:LinkButton>
                    </div>
                      </div>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body">
                <div class="form-group">   
                  ...
                  <div class="col-sm-3">   
                    <asp:DropDownList ID="DropDownPartyID" class="form-control select2 input-sm" runat="server"  AutoPostBack="True"  ontextchanged="TextPartyAddress_TextChanged" > 
                    </asp:DropDownList>  
                ...
                <div class="form-group">
                  <label  class="col-sm-2 control-label">Party Address</label> 
                  <div class="col-sm-6">   
                    <asp:DropDownList ID="DropDownPartyAddressID" class="form-control select2 input-sm" runat="server"  > 
                    </asp:DropDownList>  
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                          ControlToValidate="DropDownPartyAddressID" Display="Dynamic" 
                          ErrorMessage="Select Party Address" InitialValue="0" SetFocusOnError="True"></asp:RequiredFieldValidator>
                  </div>
                </div>
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-3">   
                    <asp:DropDownList ID="DropDownTradingVesselID" class="form-control select2 input-sm" runat="server" > 
                     ...
                     <label class="col-sm-1 control-label">Vessel Code</label> 
                   <div class="col-sm-2">    
                    <asp:TextBox ID="TextVesselCode" class="form-control input-sm"  runat="server"></asp:TextBox>  
                     <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" 
                          ControlToValidate="TextVesselCode" ErrorMessage="Insert Trading Vessel Code" 
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3" >   
                   <div class="input-group">  
                    <asp:DropDownList ID="DropDownShipmentFromToID"  class="form-control input-sm" runat="server" >   
                    </asp:DropDownList>  
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                          <div class="form-group">   
                                            ...
                                            <div class="form-group">  
                                              <label  class="col-sm-4 control-label">Contract Serial No.</label> 
                                            <div class="col-sm-4"> 
                                      ...
                                      <div class="modal-footer">
                                       ...
                                       <div class="box-body"> 
                                        <asp:GridView ID="GridView2" runat="server"    EnablePersistedSelection="true"          
                                         ...
                                         <Columns>     
                                         <asp:TemplateField HeaderText="Contract No" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate> 
                                         ...
                                         <asp:BoundField DataField="CONTRACT_DATE"  HeaderText="Contract Date"  DataFormatString="{0:dd/MM/yyyy}"  />  
        ...
        <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Sales Invoice (Overseas) List</h3>
              <div class="box-tools">
