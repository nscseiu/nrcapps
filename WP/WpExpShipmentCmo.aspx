<%@ Page Title="Shipment Status List - Waste Paper" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="WpExpShipmentCmo.aspx.cs" Inherits="NRCAPPS.WP.WpExpShipmentCmo" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
    ...
    OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="false" CssClass="table table-hover table-bordered table-striped" >
                     <Columns> 
                    <asp:BoundField DataField="EXP_WBCON_ITEM_ID" HeaderText="WB Item ID" ItemStyle-CssClass="hidden"   HeaderStyle-CssClass="hidden" /> 
              ...
              <div class="box-body"> 
                   <div class="form-group">
                    <label class="col-sm-3 control-label">WB Slip No</label>
                     <div class="col-sm-2"> 
                       <asp:TextBox  class="form-control input-sm pull-right" ID="TextWbConItemEx" style="display:none;" runat="server" ></asp:TextBox>  
