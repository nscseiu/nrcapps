<%@ Page Title="Inventory Raw Material Form & List - Waste Paper" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="WpInventoryRm.aspx.cs" Inherits="NRCAPPS.WP.WpInventoryRm" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
                ...
                <div class="input-group date">
                 ...
                 <div class="input-group-btn">
                      <asp:Button ID="BtnDataCheckWp" Class="btn btn-warning"   
                        Text="Check Inventory" runat="server" OnClick="BtnDataCheckWp_Click" 
                        CausesValidation="False" />
                  </div>  
              </div>    
            </div>
    ...
    SelectedRowStyle-BackColor="Yellow"   AutoGenerateColumns="false"   CssClass="table table-hover table-bordered table-striped" >
                     ...
                     <asp:BoundField DataField="INITIAL_STOCK_WT"  HeaderText="Initial Stock" DataFormatString="{0:0.00}" ItemStyle-HorizontalAlign="Right"  /> 
                     <asp:BoundField DataField="STOCK_IN_WT"  HeaderText="Stock In"  DataFormatString="{0:0.00}" ItemStyle-HorizontalAlign="Right" /> 
                     <asp:BoundField DataField="STOCK_OUT_WT"  HeaderText="Stock Out"  DataFormatString="{0:0.00}" ItemStyle-HorizontalAlign="Right"  /> 
                     <asp:BoundField DataField="FINAL_STOCK_WT"  HeaderText="Final Stock"  DataFormatString="{0:0.00}" ItemStyle-HorizontalAlign="Right" /> 
                     <asp:BoundField DataField="ITEM_END_AMOUNT"  HeaderText="Amount"  DataFormatString="{0:0.00}" ItemStyle-HorizontalAlign="Right"  />   
