<%@ Page Title="Item (Weight Slip) Form & List - Waste Paper" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="WpItemSalesWs.aspx.cs" Inherits="NRCAPPS.WP.WpItemSalesWs" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Item (Weight Slip) Form & List
        <small>Item (Weight Slip): - Add - Update - Delete - View</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="../Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Waste Paper</a></li>
        <li class="active">Sales Item</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12">  
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Item (Weight Slip) Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start --> 
              <div class="box-body">
               ...
               <div class="form-group">
                    <asp:TextBox ID="TextItemSalesID" style="display:none" runat="server"></asp:TextBox>
                   <label for="TextItemSalesDescription" class="col-sm-2 control-label">Description of Material</label>
                 <div class="col-sm-3">   
                    <asp:TextBox ID="TextItemSalesDescription" class="form-control input-sm"  runat="server" AutoPostBack="True" ontextchanged="TextItemSalesName_TextChanged"></asp:TextBox>   
                  </div>  
                   <div class="col-sm-3"><asp:Label ID="CheckItemSalesName" runat="server"></asp:Label> 
                </div>  </div>  
                <div class="form-group">
        ...
        <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Item (Weight Slip) List</h3>
              <div class="box-tools">
    ...
    OnPageIndexChanging="GridViewUser_PageIndexChanging" AutoGenerateColumns="false"   CssClass="table table-bordered table-striped" >
                     <Columns>
                     <asp:BoundField DataField="ITEM_WS_ID" HeaderText="Sales Item ID" />                           
                     <asp:BoundField DataField="ITEM_WS_DESCRIPTION"  HeaderText="Description of Material" />   
                     ...
                     <asp:TemplateField>
                       <ItemTemplate>
                        <asp:LinkButton ID="linkSelectClick" class="btn btn-info btn-xs" runat="server" CommandArgument='<%# Eval("ITEM_WS_ID") %>' OnClick="linkSelectClick" CausesValidation="False">Select</asp:LinkButton> 
                        </ItemTemplate>
                       </asp:TemplateField> 
                     </Columns>
