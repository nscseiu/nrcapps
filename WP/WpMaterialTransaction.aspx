<%@ Page Title="Material Transaction Form & List - Waste Paper Factory" EnableEventValidation="false" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="WpMaterialTransaction.aspx.cs" Inherits="NRCAPPS.WP.WpMaterialTransaction" %>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Waste Paper Factory</a></li>
...
<script language="javascript" type="text/javascript">
    ...
    function GetMatTransfer() {   
        ...
        if (TransactionForID == 3) {
            ...
            $.ajax({
                type: "POST",
                url: "WpMaterialTransaction.aspx/GetItemDataTransferList",
                data: '{"ItemID": "' + ItemID + '"}',
