<%@ Page Title="Purchase Form & List - Waste Paper" EnableEventValidation="false" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="WpPurchase.aspx.cs" Inherits="NRCAPPS.WP.WpPurchase" %>
  ...
  <div class="content-wrapper">
        ...
        <script language="javascript" type="text/javascript">
               ...
               function GetItemDataListWp() {
                   var ItemId = $("#ctl00_ContentPlaceHolder1_DropDownItemID").val(); 
                    $.ajax({
                        type: "POST",
                        url: "WpPurchase.aspx/GetItemDataList",
                        data: '{"ItemId": "' + ItemId + '"}',
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function (r) { 
              ...
              <div class="form-group">
                ...
                <div class="form-group">   
                   ...
                   <div class="col-sm-3">  
                    ...
                    <asp:TextBox ID="TextWpSlipNo" class="form-control input-sm"  runat="server"  ></asp:TextBox>  
                       <img src="../image/loader.gif" id="loader" style="display:none" height="20px" alt="" />
                     <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                          ControlToValidate="TextWpSlipNo" ErrorMessage="Insert Slip No." 
                  ...
                  <div class="col-sm-3">    
                      <asp:DropDownList ID="DropDownCollectionFor" class="form-control input-sm" runat="server"> 
                    </asp:DropDownList>  
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator21" runat="server" 
                          ControlToValidate="DropDownCollectionFor" Display="Dynamic" 
                          ErrorMessage="Select Collection For" InitialValue="0" SetFocusOnError="True"></asp:RequiredFieldValidator>
                  </div>
               </div>
               <div class="form-group">
                  ...
                  <div class="col-sm-3">   
                    <asp:DropDownList ID="DropDownSupplierCategory" class="form-control input-sm" runat="server"> 
                    </asp:DropDownList>  
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator20" runat="server" 
                          ControlToValidate="DropDownSupplierCategory" Display="Dynamic" 
                          ErrorMessage="Select Supplier Category" InitialValue="0" SetFocusOnError="True"></asp:RequiredFieldValidator>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-3">   
                    <asp:DropDownList ID="DropDownDriverID" class="form-control input-sm" runat="server"> 
                    </asp:DropDownList>  
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" 
                          ControlToValidate="DropDownDriverID" Display="Dynamic" 
                          ErrorMessage="Select Driver" InitialValue="0" SetFocusOnError="True"></asp:RequiredFieldValidator>
                  </div>
                </div>
               ...
               <div class="form-group"> 
                  ...
                  <label  class="col-sm-2 control-label">Garbage Percent</label> 
                  <div class="col-sm-3">  
                   <div class="input-group"> 
                    <asp:DropDownList ID="DropDownPgeID" class="form-control input-sm" runat="server" >   
                    </asp:DropDownList>  
                      <span class="input-group-addon">%</span>  
                      </div>
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server" 
                          ControlToValidate="DropDownPgeID" Display="Dynamic" 
                          ErrorMessage="Select Garbage Percent (%)" InitialValue="0" SetFocusOnError="True"></asp:RequiredFieldValidator>  
                </div> 
    ...
    SelectedRowStyle-BackColor="Yellow"  AutoGenerateColumns="false" ShowHeader="true"  ShowFooter="true" CssClass="table  table-sm table-bordered table-striped"  >
      ...
      <div class="col-md-12">        
        <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Purchase List (Last 3 days data - Default)</h3>
              <div class="box-tools">
              <div class="col-sm-5">   
    ...
    SelectedRowStyle-BackColor="Yellow"   AutoGenerateColumns="false" CssClass="table table-hover table-bordered table-striped" >
                     ...
                     <asp:BoundField DataField="SUPPLIER_CAT_NAME" HeaderText="Supplier Cat" />
                     <asp:BoundField DataField="DRIVER_NAME"  HeaderText="Driver" />    
                     <asp:BoundField DataField="COLLECTION_FOR_NAME"  HeaderText="Coll For" />                           
         ...
         <!-- /.box -->
            ...
            <!-- form start -->   
              <div class="form-group">
                  ...
                  <div class="col-sm-5">   
                    <asp:ListBox ID="DropDownSupplierCategory2" class="form-control select2 input-sm" SelectionMode="multiple" runat="server"> 
                    </asp:ListBox>  
         ...
         <!-- /.box -->
            ...
            <%if (IsLoad6)
                {   string ItemIDList ="";
                    for(int i=0;i<DropDownSupplierCategory2.Items.Count;++i)
                    {
                        if(DropDownSupplierCategory2.Items[i].Selected==true) { 
                        ItemIDList += DropDownSupplierCategory2.Items[i].Value + "-";
                        }
                    }
               %> 
            <div class="box box-success">
            ...
            <!-- /.box-header -->
                    <div class="box-body table-responsive">       
                           <iframe src="WP_Reports/WpPurchaseDriverWiseReportView.aspx?StartDate=<%=EntryDate4.Text %>&EndDate=<%=EntryDate5.Text %>&DriverID=<%=DropDownDriverID2.Text %>&DropDownSupplierCategory2=<%=ItemIDList%>" width="950px" id="iframe1"
                        marginheight="0" frameborder="0" scrolling="auto" height="1250px">   </iframe>  
                         </div>
                       </div> 
