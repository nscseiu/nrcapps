<%@ Page Title="Sales (Local) Form & List - Waste Paper" Language="C#" MasterPageFile="~/Site.Master" EnableEventValidation="false" AutoEventWireup="true"  CodeBehind="WpSales.aspx.cs" Inherits="NRCAPPS.WP.WpSales" %>
                       ...
                       <div class="col-sm-3">   
                        <asp:TextBox ID="TextInvoiceWpNo" class="form-control input-sm"  runat="server" ></asp:TextBox>  
                         ...
                         <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                              ControlToValidate="TextInvoiceWpNo" ErrorMessage="Insert Invoice No." 
