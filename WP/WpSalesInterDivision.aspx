<%@ Page Title="Sales (Inter Division) Form & List - Waste Paper" Language="C#" MasterPageFile="~/Site.Master" EnableEventValidation="false" AutoEventWireup="true"  CodeBehind="WpSalesInterDivision.aspx.cs" Inherits="NRCAPPS.WP.WpSalesInterDivision" %>
  ...
  <div class="content-wrapper">
            ...
            <!-- form start --> 
              <div class="box-body">    
                  <div class="form-group">   
                       ...
                       <div class="col-sm-3">   
                        <asp:TextBox ID="TextInvoiceWpNo" class="form-control input-sm"  runat="server" ></asp:TextBox>  
                            <img src="../image/loader.gif" id="loader" style="display:none" height="20px" alt="" />
                         <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                              ControlToValidate="TextInvoiceWpNo" ErrorMessage="Insert WB Slip No." 
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">   
                    <asp:DropDownList ID="DropDownItemID" class="form-control input-sm" runat="server" >  </asp:DropDownList>  
    ...
    OnPageIndexChanging="GridViewEmp_PageIndexChanging" AutoGenerateColumns="false" CssClass="table table-bordered table-striped" >
                     ...
                     <asp:BoundField DataField="ENTRY_DATE"  HeaderText="Entry Date" DataFormatString="{0:dd/MM/yyyy}"  /> 
                       <asp:TemplateField>
                       <ItemTemplate>
                        <asp:LinkButton ID="linkPrintClick" class="btn btn-warning btn-xs" runat="server" CommandArgument='<%# Eval("WB_SLIP_NO") %>' OnClick="btnPrint_Click" CausesValidation="False">PO Print</asp:LinkButton> 
                        </ItemTemplate>
                       </asp:TemplateField> 
