<%@ Page Title="Supplier Category Form & List - Waste Paper" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="WpSupplierCat.aspx.cs" Inherits="NRCAPPS.WP.WpSupplierCat" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder1"> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
         Supplier Category Form & List
        <small>Supplier Category: - Add - Update - Delete - View</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="../Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Waste Paper</a></li>
        <li class="active">Supplier Category</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Supplier Category Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start --> 
              <div class="box-body">
                <div class="form-group">  
                   <label for="User_Name" class="col-sm-2 control-label"> Supplier Category Name</label>
                 <div class="col-sm-3">  
                    <asp:TextBox ID="TextSupplierCatID" style="display:none" runat="server"></asp:TextBox>
                    <asp:TextBox ID="TextSupplierCatName" class="form-control input-sm"  runat="server" AutoPostBack="True" ontextchanged="TextSupplierCatName_TextChanged"></asp:TextBox>  
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                         ControlToValidate="TextSupplierCatName" ErrorMessage="Insert  Supplier Category Name" 
                         SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator> 
                  </div> 
                    <div class="col-sm-3"><asp:Label ID="CheckSupplierCatName" runat="server"></asp:Label> 
                    </div>
                </div>
        ...
        <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Procurement SupplierCat List</h3>
              <div class="box-tools">
    ...
    OnPageIndexChanging="GridViewUser_PageIndexChanging" AutoGenerateColumns="false"   CssClass="table table-bordered table-striped" >
                     <Columns>
                     <asp:BoundField DataField="SUPPLIER_CAT_ID" HeaderText="Supplier Category ID" />  
                     <asp:BoundField DataField="SUPPLIER_CAT_NAME"  HeaderText="Supplier Category Name" />    
                     ...
                     <asp:TemplateField>
                       <ItemTemplate>
                        <asp:LinkButton ID="linkSelectClick" class="btn btn-info btn-xs" runat="server" CommandArgument='<%# Eval("SUPPLIER_CAT_ID") %>' OnClick="linkSelectClick" CausesValidation="False">Select</asp:LinkButton> 
                        </ItemTemplate>
                       </asp:TemplateField> 
                     </Columns>
